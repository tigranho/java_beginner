    ...
    <div class="fixed-header">
        <header>
            <div class="inner-container large">
               ...
               <span class="logo">
                   <a href="App?PageLanguage=${requestScope.Pagelanguage}"><img src="../images/oferta.png" alt=""/></a>
               </span>
    ...
    <c:if test="${requestScope.TheList != null}">
        <c:forEach items="${requestScope.TheList}" var="details">
            <div class="bg-white-dark padding-bottom-60 bank-item-page">
                ...
                <div class="row row-flex flex flex-wrap credit-info width-percent-80">
                    <div class="col-4 flex align-items-center item">
                        <c:set var="monthsSectionMain" value='<%=request.getParameter("months")%>' scope="request"/>
                        <c:set var="monthsSectionMain" value='<%=request.getAttribute("months")%>' scope="request"/>
                        ...
                        <%
                            ...
                            if (request.getParameter("monthsSectionMain") != null && request.getParameter("monthsSectionMain").equals("0")) {
                                monthsSectionMain = Integer.parseInt(String.valueOf(request.getParameter("monthsSectionMain")));
                            } else {
                                monthsSectionMain = Integer.parseInt(String.valueOf(request.getAttribute("monthsSectionMain")));
                            }
                        %>
                        <%
                    ...
                    <%
                        if (request.getParameter("monthsSectionMain") != null && request.getParameter("monthsSectionMain").equals("0")) {
                            monthsMain = Integer.parseInt(String.valueOf(request.getParameter("monthsSectionMain")));
                            if (monthsMain == 30 || monthsMain == 90 || monthsMain == 180 || monthsMain == 270 || monthsMain == 360 || monthsMain == 540 || monthsMain == 720 || monthsMain == 1080) {
                                monthsMain /= 30;
                            }
                        } else {
                            monthsMain = Integer.parseInt(String.valueOf(request.getAttribute("monthsSectionMain")));
                            if (monthsMain == 30 || monthsMain == 90 || monthsMain == 180 || monthsMain == 270 || monthsMain == 360 || monthsMain == 540 || monthsMain == 720 || monthsMain == 1080) {
                                monthsMain /= 30;
                            }
                        }
                    ...
                    <div class="row-md clearfix form-row">
                        <div class="col-12">
                            ...
                            <div class="def-select-box">
                                ...
                                <% if (request.getParameter("monthsSectionMain") != null && request.getParameter("monthsSectionMain").equals("0")) {
                                    monthsFinal = Integer.parseInt(String.valueOf(request.getParameter("monthsSectionMain")));
                                    ...
                                    monthsFinal = Integer.parseInt(String.valueOf(request.getAttribute("monthsSectionMain")));
                                    if (monthsFinal == 30 || monthsFinal == 90 || monthsFinal == 180 || monthsFinal == 270 || monthsFinal == 360 || monthsFinal == 540 || monthsFinal == 720 || monthsFinal == 1080) {
                                        monthsFinal /= 30;
                                    }
                                }
                    ...
                    <div class="row-lg">
                        <div class="col-4 col rigthtwo-one">
                            ...
                            <%
                                ...
                                if (request.getParameter("monthsSectionMain") != null && request.getParameter("monthsSectionMain").equals("0")) {
                                    monthForRange = Integer.parseInt(String.valueOf(request.getParameter("monthsSectionMain")));

                                } else {
                                    monthForRange = Integer.parseInt(String.valueOf(request.getAttribute("monthsSectionMain")));
                                    ...
                                    <li class="flex align-items-center">
                                        ...
                                        <c:choose>
                                            ...
                                            <c:when test="${checkName == null && checkName2 == null}">
                                                ...
                                                <%
                                                    if (request.getParameter("monthsSectionMain") != null && request.getParameter("monthsSectionMain").equals("0")) {
                                                        MonthsSet = Integer.parseInt(String.valueOf(request.getParameter("monthsSectionMain")));

                                                    } else {
                                                        MonthsSet = Integer.parseInt(String.valueOf(request.getAttribute("monthsSectionMain")));
                                    ...
                                    <li class="flex align-items-center">
                                        ...
                                        <%!
                                            long calculatePercentagetop(float Amount, double Percentage, int month) {
                                                ...
                                                float result = (finalStep2 * month);
                                                float finalResult = (float) ((result - (result * 0.10)));
                                        ...
                                        <%
                                            ...
                                            if (request.getParameter("monthsSectionMain") != null && request.getParameter("monthsSectionMain").equals("0")) {
                                                monthtop = Integer.parseInt(String.valueOf(request.getParameter("monthsSectionMain")));
                                                if (monthtop == 30 || monthtop == 90 || monthtop == 180 || monthtop == 270 || monthtop == 360 || monthtop == 540 || monthtop == 720 || monthtop == 1080) {
                                                    monthtop /= 30;
                                                }
                                            } else {
                                                monthtop = Integer.parseInt(String.valueOf(request.getAttribute("monthsSectionMain")));
                                                if (monthtop == 30 || monthtop == 90 || monthtop == 180 ||monthtop == 270 || monthtop == 360 || monthtop == 540 || monthtop == 720 || monthtop == 1080) {
                                                    monthtop /= 30;
                                                }
                                            }
                                        ...
                                        <%!
                                            long CalculateSecondAMountPercentage(long AmountSecond, double Percentage, int Months) {
                                                ...
                                                double per = Percentage / 100;
                                                double firstStep = Math.round(AmountSecond * per);
                                                float secondStep = (float) Math.round(firstStep / 365);
                                                float finalStep2 = Math.round(secondStep * 31);
                                                float result = Math.round(finalStep2 * Months - 1);
                                                float finalResult = (float) Math.round(AmountSecond + (result - (result * 0.10)));
                                                return (int) Math.round(finalResult);
                                            }
                                        %>
                            ...
                            <div class="total-info margin-top-0">
                                <div class="flex  margin-bottom-15">
                                    ...
                                    <div>
                                        ...
                                        <%
                                            long deposiIncome = Long.parseLong(String.valueOf(request.getAttribute("incomeInMonths")));
