                ...
                <div class="row-md clearfix">
                    <div class="col-3 large col">
                        <form name="main" action="AutoCalulate" method="get">
                            <span class="label">Մուտքագրեք ավտոմեքենայի արժեքը</span>
                            ...
                            <div class="def-range">
                                <c:if test="${requestScope.valueTwo!=null}">
                                    <c:forEach items="${requestScope.dropDownsListWithCurrancy}"
                                        ...
                                        <c:set value='<%=request.getParameter("percentageSecond")%>' var="percentageSecond" scope="request"/>
                                        ...
                                        <%!
                                            int finalStepNull(){
                                                int stepResult =stepsDividNull/5;
                                                return stepResult;
                                            }
                                        %>
                                        <%
                                            stepsDividNull = Integer.parseInt(String.valueOf(request.getAttribute("step")));
                                        ...
                                        <input type="text" name="value_two" min="<%=discountingAmount(discountAmount,10)%> "
                                               max="<%=maximumAmount(discountAmount)%>" step="<%=finalStepNull()%>"
                                               value='<%=discountingAmount(discountAmount,percentageForDiscount)%>'
                                               oninput="showVal(this.value)"
                                               onchange="showVal(this.value)" id="amount_two" inputmode="numeric">

                                        <input type="range" name="range_two" min="<%=discountingAmount(discountAmount,10)%>"
                                               max="<%=maximumAmount(discountAmount)%>" step="<%=finalStepNull()%>"
                                               value='<%=discountingAmount(discountAmount,percentageForDiscount)%>' data-rangeslider=""
                                               id="amount_range_two"
                                               style="position: absolute; width: 1px; height: 1px; overflow: hidden; opacity: 0;"
                                               onchange="doSearch();">
                                ...
                                <c:if test="${requestScope.valueTwo==null}">
                                    <c:forEach items="${requestScope.dropDownsListWithCurrancy}"
                                               var="dropDownList3"
                                               varStatus="loop">
                                        <c:set value="${dropDownList3.minAmount}" var="AmountDiscounted2" scope="request"/>
                                        <c:set value='<%=request.getAttribute("percentageSecond")%>' var="percentageSecond2" scope="request"/>
                                        ...
                                        <input type="text" name="value_two" min="<%=discountingAmount2(discountAmount2,percentageForDiscount2)%>"
                                               max="<%=maximumAmount2(discountAmount2)%>" step="<%=finalStep()%>"
                                               value='<%=discountingAmount2(discountAmount2,percentageForDiscount2)%>'
                                               oninput="showVal(this.value)"
                                               onchange="showVal(this.value)" id="amount_two" inputmode="numeric">

                                        <input type="range" name="range_two" min="<%=discountingAmount2(discountAmount2,percentageForDiscount2)%>"
                                               max="<%=maximumAmount2(discountAmount2)%>" step="<%=finalStep()%>"
                                               value='<%=discountingAmount2(discountAmount2,percentageForDiscount2)%>' data-rangeslider
                                               id="amount_range_two" onchange="doSearch();">


                                        <input type="hidden" name="value_url" id="value_amount_url">
                                        <c:set value='<%=discountingAmount2(discountAmount2,percentageForDiscount2)%>' var="range2" scope="request"/>
                                        <%!
                                            static int ranger;
                                        %>
                                        <%
                    ...
                    <div class="col-2 small col">
                        ...
                        <div class="def-select-box">
                            <select name="months" id="select_month" onchange="document.main.submit();">
                                ...
                                <option value="120">120 ամիս</option>
                            </select>
                    ...
                    <c:forEach items="${requestScope.depositeAseList}" var="SpecialDeposit">
                        <div class="table">
                            <div class="table-row">
                                ...
                                <div class="table-cell">
                                        <%-- <p>Մինչեւ ${SpecialDeposit.CLMaxPeriodMonths} Ամիս</p>--%>
                                    <c:set value="${requestScope.PageCurrancy}" var="curancy"/>
                                    <c:choose>
                                        <c:when test="${curancy == 'AMD'}">
                                            <p class="font-24 bold"><fmt:formatNumber type="number" maxFractionDigits="3" value="${SpecialDeposit.CLMinAmount}"/> - <fmt:formatNumber type="number" maxFractionDigits="3" value="${SpecialDeposit.CLMaxAmount}"/></p>                                           </c:when>
                                        <c:when test="${curancy == 'USD'}">
                                            <p class="font-24 bold"><fmt:formatNumber type="number" maxFractionDigits="3" value="${SpecialDeposit.CLMinAmount}"/> - <fmt:formatNumber type="number" maxFractionDigits="3" value="${SpecialDeposit.CLMaxAmount}"/></p>
                                        </c:when>
                                ...
                                <div class="table-cell text-center">
                                    ...
                                    <a href="CreditSend?ProductCode=${SpecialDeposit.productCode}&&range_two=<%=Integer.parseInt(String.valueOf(request.getAttribute("range2")))%>&&MaxAmount=<%=request.getParameter("MaxAmounr")%>&&percentageSecond=<%=percentageForDiscount2%>&&months=0&&PageToGo=Cars&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&Amount=<%=request.getAttribute("range")%>"
                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ ավելին</a>
                                    <p>
                                        <a href="AutoClient?id=${SpecialDeposit.productCode}&&percentageSecond=<%=percentageForDiscount2%>&&range_two=<%=ranger%>&&options=0&&months=0&&MaxAmount=<%=request.getAttribute("maxAmount")%>&&City=<%=request.getAttribute("city")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                    ...
                                    <p><a href="AutoClient?id=${SpecialDeposit.productCode}&&percentageSecond=<%=percentageForDiscount2%>&&range_two=<%=ranger%>&&options=0&&months=0&&MaxAmount=<%=request.getAttribute("maxAmount")%>&&City=<%=request.getAttribute("city")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                          class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                    ...
                                    <p><a href="AutoClient?id=${SpecialDeposit.productCode}&&percentageSecond=<%=percentageForDiscount2%>&&range_two=<%=ranger%>&&options=0&&months=0&&MaxAmount=<%=request.getAttribute("maxAmount")%>&&City=<%=request.getAttribute("city")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                        ...
                                        <a href="${SpecialDeposit.bankLink}"
                                           class="def-button btn-green with-shadow  margin-bottom-15" target="_blank">Անցնել էջ</a>
                                    <p><a href="AutoClient?id=${SpecialDeposit.productCode}&&percentageSecond=<%=percentageForDiscount2%>&&range_two=<%=ranger%>&&options=0&&months=1&&MaxAmount=<%=request.getAttribute("maxAmount")%>&&City=<%=request.getAttribute("city")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                          class="blue-link font-12 linkScrollDown">Համեմատել</a>
                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <form action="AutoClient" method="post" name="SortingPercentageDesc">
                            ...
                            <form action="AutoClient" method="post" name="SortingPercentageAsec">
                        ...
                        <div class="table-cell">
                            ...
                            <span>Գումար</span>
                            <form action="AutoClient" method="post" name="SortingPercentageDescAmount">
                            ...
                            <form action="AutoClient" method="post" name="SortingPercentageAsecAmount">
                                                ...
                                                <div class="table">
                                                    <div class="table-row">
                                                        ...
                                                        <div class="table-cell">
                                                            ...
                                                            <p class="font-28 bold">${firstDepo.CLFatual}%</p>
                                                            <small>№ ${firstDepo.productCode}</small>
                                                        </div>
                                                        <div class="table-cell">
                                                                <%-- <p>Մինչեւ ${firstDepo.CLMaxPeriodMonths} Ամիս</p>--%>
                                                            <c:set value="${requestScope.PageCurrancy}" var="curancy"/>
                                                            <c:choose>
                                                                <c:when test="${curancy == 'AMD'}">
                                                                    <p  class="font-24 bold"><fmt:formatNumber type="number" maxFractionDigits="3" value="${firstDepo.CLMinAmount}"/> - <fmt:formatNumber type="number" maxFractionDigits="3"  value="${firstDepo.CLMaxAmount}"/></p>
                                                                </c:when>
                                                                <c:when test="${curancy == 'USD'}">
                                                                    <p  class="font-24 bold"><fmt:formatNumber type="number" maxFractionDigits="3" value="${firstDepo.CLMinAmount}"/> - <fmt:formatNumber type="number" maxFractionDigits="3"  value="${firstDepo.CLMaxAmount}"/></p>
                                                                </c:when>
                                                        ...
                                                        <div class="table-cell text-center last">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                    ...
                                                                    <a href="CreditSend?ProductCode=${firstDepo.productCode}&&range_two=<%=Integer.parseInt(String.valueOf(request.getAttribute("range2")))%>&&MaxAmount=<%=request.getParameter("MaxAmounr")%>percentageSecond=<%=percentageForDiscount2%>&&months=0&&PageToGo=Cars&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&Amount=<%=request.getAttribute("range")%>"
                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                        ավելին</a>
                                                                    <a href="AutoClient?id=${firstDepo.productCode}&&percentageSecond=<%=percentageForDiscount2%>&&range_two=<%=ranger%>&&options=0&&months=0&&MaxAmount=<%=request.getAttribute("maxAmount")%>&&City=<%=request.getAttribute("city")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                                ...
                                                                <c:when test="${gotoPage == 0 && sendRequest==0  && lastLogic == 1}">
                                                                    <a href="${firstDepo.bankLink}"
                                                                       class="def-button btn-green with-shadow  margin-bottom-15" target="_blank">Անցնել
                                                                        էջ</a>
                                                                    <a href="AutoClient?id=${firstDepo.productCode}&&percentageSecond=<%=percentageForDiscount2%>&&range_two=<%=ranger%>&&options=0&&months=1&&MaxAmount=<%=request.getAttribute("maxAmount")%>&&City=<%=request.getAttribute("city")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                                    <%--<p><a href="index.php?page=compare/deposit"
                                                                          class="blue-link font-12">Համեմատել</a></p>--%>
                                                                </c:when>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <c:forEach var="seconDepo" items="${rs.rows}"
                                                                    ...
                                                                    <c:set value="${seconDepo.orderOfAppearance}"
                                                                           var="orderOfAppearance"/>
                                                                            ...
                                                                            <c:if test="${bank == bankSub }">
                                                                                ...
                                                                                <div class="table">
                                                                                    <div class="table-row">
                                                                                        ...
                                                                                        <div class="table-cell">
                                                                                            <c:out value="${seconDepo.productName}"/>
                                                                                            <p class="font-28 bold">${seconDepo.CLFatual}%</p>
                                                                                            <small>№ ${seconDepo.productCode}</small>


                                                                                        </div>
                                                                                        <div class="table-cell">
                                                                                                <%-- <p>Մինչեւ ${seconDepo.CLMaxPeriodMonths} Ամիս</p>--%>
                                                                                            <c:set value="${requestScope.PageCurrancy}" var="curancy"/>
                                                                                            <c:choose>
                                                                                                <c:when test="${curancy == 'AMD'}">
                                                                                                    <p  class="font-24 bold"><fmt:formatNumber type="number" maxFractionDigits="3" value="${seconDepo.CLMinAmount}"/> - <fmt:formatNumber type="number" maxFractionDigits="3" value="${seconDepo.CLMaxAmount}"/></p>
                                                                                                </c:when>
                                                                                                <c:when test="${curancy == 'USD'}">
                                                                                                    <p  class="font-24 bold"><fmt:formatNumber type="number" maxFractionDigits="3" value="${seconDepo.CLMinAmount}"/> - <fmt:formatNumber type="number" maxFractionDigits="3" value="${seconDepo.CLMaxAmount}"/></p>
                                                                                                </c:when>
                                                                                        ...
                                                                                        <div class="table-cell text-center">
                                                                                            ...
                                                                                            <c:choose>
                                                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                                                    <a href="CreditSend?ProductCode=${seconDepo.productCode}&&range_two=<%=Integer.parseInt(String.valueOf(request.getAttribute("range2")))%>&&MaxAmount=<%=request.getParameter("MaxAmounr")%>percentageSecond=<%=percentageForDiscount2%>&&months=0&&PageToGo=Cars&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&Amount=<%=request.getAttribute("range")%>"
                                                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                                                        ավելին</a>

                                                                                                    <a href="AutoClient?id=${seconDepo.productCode}&&percentageSecond=<%=percentageForDiscount2%>&&range_two=<%=ranger%>&&options=0&&months=1&&MaxAmount=<%=request.getAttribute("maxAmount")%>&&City=<%=request.getAttribute("city")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                                                                    <%--<p>
                                                                                                ...
                                                                                                <c:when test="${gotoPage == 0 && sendRequest==0  && lastLogic == 1}">
                                                                                                    ...
                                                                                                    <a href="AutoClient?id=${seconDepo.productCode}&&range_two=<%=discountingAmount(discountAmount,percentageForDiscount)%>&&percentageSecond=<%=percentageForDiscount2%>&&range_two=<%=ranger%>&&options=0&&months=1&&MaxAmount=<%=request.getAttribute("maxAmount")%>&&City=<%=request.getAttribute("city")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                                                                    <%-- <p>
                                                                                                         <a href="index.php?page=compare/deposit"
                                                                                                            class="blue-link font-12">Համեմատել</a>
                                                                                                ...
                                                                                                <c:otherwise>
                                                                                                    ...
                                                                                                    <a href="AutoClient?id=${seconDepo.productCode}&&percentageSecond=<%=percentageForDiscount2%>&&range_two=<%=ranger%>&&options=0&&months=0&&MaxAmount=<%=request.getAttribute("maxAmount")%>&&City=<%=request.getAttribute("city")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                                                                    <%-- <p>
                                                                                                         <a href="index.php?page=compare/deposit"
                                                                                                            class="blue-link font-12">Համեմատել</a>
            ...
            <div class="padding-bt-60">
                <div class="inner-container">
                   ...
                   Սպառողական վարկ</span>
                            <span class="tab-link active" onclick="openTabItem(event, 'car-loan')" id="defaultOpen">
                    Ավտովարկ</span>
