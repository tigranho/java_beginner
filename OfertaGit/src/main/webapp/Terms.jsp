...
<div class="page-container">
                         ...
                         <div class="tooltip">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="Policy" method="post" name="Delete">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="Policy" method="post" name="DeleteHipotek">
                            ...
                            <ul>
                                <li>
                                  ...
                                  <form action="Policy" method="post" name="DeleteConsumer">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="Policy" method="post" name="DeleteCar">
                           ...
                           <%-- <form action="CompareMicro" method="post" name="MicroCompare">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="Policy" method="post" name="DeleteAG">
    ...
    <div class="padding-bt-60 bg-white-dark">
        <div class="inner-container about-us-page">
            <p class="title font-24 line-height-36">Գաղտնիության քաղաքականություն</p>
            <c:if test="${requestScope.policyList != null}">
                <c:forEach var="about" items="${requestScope.policyList}">

                    <p class="title font-24 line-height-36 margin-top-100">${about.termsAm}
                    </p>
