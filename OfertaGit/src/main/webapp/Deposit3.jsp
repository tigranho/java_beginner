                            ...
                            <div class="table-row">
                                ...
                                <div class="table-cell">
                                    ...
                                    <%-- <div class="table-cell">
                                         ...
                                         <p class="font-12 bold">${SpecialDeposit.productCode}</p>
                                     </div>--%>
                                <div class="table-cell">
                                    <p>Գումար</p>
                                        ...
                                        <c:when test="${curancy == 'AMD'}">
                                            <p class="font-24 bold"><fmt:formatNumber type="number"
                                                ...
                                                - <fmt:formatNumber type="number" maxFractionDigits="3"
                                                                    value="${SpecialDeposit.DMaxAmount}"/></p>
                                        </c:when>
                                ...
                                <div class="table-cell text-center">
                                    ...
                                    <a href="Credits?ProductCode=${SpecialDeposit.productCode}&FromPageName=Deposit&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&range=<%=request.getAttribute("range")%>&&Currancy=<%=request.getParameter("Currancy")%>&&value_two=0&&months=1"
                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ ավելին</a>
                                    <p>
                                        <a href="DepositClient?id=${SpecialDeposit.productCode}&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=Deposits&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <form action="DepositClient" method="post" name="SortingPercentageDesc">

                                <input name="MaxAmounr" value="<%=request.getParameter("MaxAmounr")%>" type="hidden">
                                <input name="City" value="<%=request.getAttribute("City")%>" type="hidden">
                            ...
                            <form action="DepositClient" method="post" name="SortingPercentageAsec">
                        ...
                        <div class="table-cell">
                            ...
                            <span>Գումար</span>
                            <form action="DepositClient" method="post" name="SortingPercentageDescAmount">
                            ...
                            <form action="DepositClient" method="post" name="SortingPercentageAsecAmount">
                                                ...
                                                <div class="table">
                                                    <div class="table-row">
                                                            ...
                                                            <p class="margin-top-20 hide-for-mb">
                                                                <a class="green-link font-12 width-icon right-icon ellipsis">
                                                                    ...
                                                                    <sql:query dataSource="${db}" var="count">
                                                                        SELECT * FROM depositecontroller ;
                                                                    </sql:query>
                                                        ...
                                                        <div class="table-cell">
                                                            ...
                                                            <%-- <div class="table-cell">
                                                                 <p class="font-18 bold">${firstDepo.productName}</p>
                                                                 <p class="font-12 bold">${firstDepo.productCode}</p>
                                                                 </p>
                                                             </div>--%>
                                                            <%--<div class="table-cell">
                                                               &lt;%&ndash; <p>Տոկոս</p>&ndash;%&gt;
                                                                <p class="font-22 bold">${firstDepo.DPercentage}%</p>
                                                            </div>--%>
                                                        <div class="table-cell">
                                                                <%--<p>գումարը</p>--%>
                                                            ...
                                                            <p class="font-24 bold"><fmt:formatNumber type="number"
                                                                                                      maxFractionDigits="3"
                                                                                                      value="${firstDepo.DMinAmount}"/>
                                                                - <fmt:formatNumber type="number" maxFractionDigits="3"
                                                                                    value="${firstDepo.DMaxAmount}"/></p>
                                                        ...
                                                        <div class="table-cell text-center last">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                    <a href="Credits?ProductCode=${firstDepo.productCode}&FromPageName=Deposit&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&range=<%=request.getAttribute("range")%>&&Currancy=<%=request.getParameter("Currancy")%>&&value_two=0&&months=0"
                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                        ավելին</a>
                                                                    <a href="DepositClient?id=${firstDepo.productCode}&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=Deposits&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit&&months=0"
                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                                                ...
                                                                                <div class="table">
                                                                                    <div class="table-row">
                                                                                        <div class="table-cell item-img">
                                                                                            ...
                                                                                            <%-- <div class="table-cell">
                                                                                                 <p class="font-18 bold">${seconDepo.productName}</p>
                                                                                                 <p class="font-12 bold">${seconDepo.productCode}</p>
                                                                                             </div>--%>
                                                                                        <div class="table-cell">
                                                                                            <c:out value="${seconDepo.productName}"/><br>
                                                                                            <p class="font-28 bold">${seconDepo.DPercentage}%</p>
                                                                                            <small>
                                                                                                № ${seconDepo.productCode}</small>
                                                                                        </div>
                                                                                            <%-- <div class="table-cell">
                                                                                                &lt;%&ndash; <p>Տոկոս</p>&ndash;%&gt;
                                                                                                 <p class="font-22 bold">${seconDepo.DPercentage}%</p>
                                                                                             </div>--%>
                                                                                        <div class="table-cell">
                                                                                                <%--<p>գումարը</p>--%>
                                                                                            <p class="font-22 bold">
                                                                                            ...
                                                                                            <p class="font-24 bold">
                                                                                                <fmt:formatNumber
                                                                                                        type="number"
                                                                                                        maxFractionDigits="3"
                                                                                                        value="${seconDepo.DMinAmount}"/>
                                                                                                - <fmt:formatNumber
                                                                                                    type="number"
                                                                                                    maxFractionDigits="3"
                                                                                                    value="${seconDepo.DMaxAmount}"/></p>
                                                                                            ...
                                                                                            <p>
                                                                                                ...
                                                                                                <c:forEach
                                                                                                    ...
                                                                                                    <c:set value="${seconDepo.productCode}"
                                                                                                           var="productCodesec"/>
                                                                                                    <c:if test="${productCodesec == productCodeSql }">
                                                                                                        <c:out value="${CommentsDao.Comment1_Am}"/>
                                                                                                        <%--  <c:out value="${CommentsDao.Comment2_Am}"/>
                                                                                                          <c:out value="${CommentsDao.Comment3_Am}"/>--%>
                                                                                        ...
                                                                                        <div class="table-cell text-center">
                                                                                            ...
                                                                                            <c:choose>
                                                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                                                    <a href="Credits?ProductCode=${seconDepo.productCode}&FromPageName=Deposit&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&range=<%=request.getAttribute("range")%>&&Currancy=<%=request.getParameter("Currancy")%>&&value_two=0&&months=0"
                                                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                                                        ավելին</a>

                                                                                                    <a href="DepositClient?id=${seconDepo.productCode}&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=Deposits&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit&&months=0"
                                                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                                                                    <%--<p>
