        ...
        <div class="inner-container">
            ...
            <div class="row row-flex flex flex-wrap credit-info">
                ...
                <div class="col-4 flex align-items-center item">
                    ...
                    <span>Վարկի գումարը</span><span><fmt:formatNumber type="number" maxFractionDigits="3" value="${details.MMinAmount}"/>  -  <fmt:formatNumber  type="number" maxFractionDigits="3"  value="${details.MMaxAmount}"/></span>
                </div>
                <div class="col-4 flex align-items-center item">
                    <span>Սպասարկման վճար</span><span><fmt:formatNumber type="number" maxFractionDigits="3" value="${details.MMinServiceFee}"/></span>
                </div>
                <div class="col-4 flex align-items-center item">
