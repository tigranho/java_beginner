            ...
            <div class="inner-container info-container">
                ...
                <div class="row-md clearfix">
                    <div class="col-3 large col">
                        <form name="main" action="AutoCalulate" method="post">
                    ...
                    <div class="col-3 large col">
                        ...
                        <div class="range-group">
                            <div class="def-range">
                                ...
                                <c:if test="${requestScope.valueTwo==null}">
                                    <c:forEach items="${requestScope.dropDownsListWithCurrancy}" var="dropDownList3" varStatus="loop">
                                        <c:set value="${dropDownList2.minAmount}" var="AmountDiscounted" scope="request"/>
                    ...
                    <div class="col-2 small col">
                        ...
                        <div class="def-select-box">
                            ...
                            <select name="months" id="select_month" onchange="document.main.submit();">
                                <option value="1" <c:if test="${monthsSection == '1'}">selected</c:if>>Բոլորը</option>
                                <option value="12" <c:if test="${monthsSection == '12'}">selected</c:if>>12 ամիս
                                </option>
                                <option value="18" <c:if test="${monthsSection == '18'}">selected</c:if>>18 ամիս
                                </option>
                                <option value="24" <c:if test="${monthsSection == '24'}">selected</c:if>>24 ամիս
                                </option>
                                <option value="36" <c:if test="${monthsSection == '36'}">selected</c:if>>36 ամիս
                                </option>
                                <option value="48" <c:if test="${monthsSection == '48'}">selected</c:if>>48 ամիս
                                </option>
                                <option value="60" <c:if test="${monthsSection == '60'}">selected</c:if>>60 ամիս
                                </option>
                                <option value="120" <c:if test="${monthsSection == '120'}">selected</c:if>>120 ամիս
                                </option>
                            </select>
                            ...
                            <div class="table-row">
                                ...
                                <div class="table-cell">
                                    ...
                                    <%
                                        ...
                                        AmountMain = Long.parseLong((String) request.getAttribute("minAmount"));//100000
                                    ...
                                    %>
                                    <c:set var="SecondAmount"  value='<%=discountingAmount2(AmountMain,percentageForDiscount2)%>' scope="request"/>
                                    <%
                                        secoundAmount = 0;
                                ...
                                <div class="table-cell text-center">
                                    ...
                                    <p>
                                        <a href="AutoCalulate?id=${SpecialDeposit.productCode}&&percentageSecond=<%=request.getAttribute("percentageSecond")%>&&range_two=<%=request.getAttribute("RangeTwo")%>&&months=<%=request.getParameter("months")%>&&MaxAmount=<%=request.getParameter("MaxAmount")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getParameter("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <span>Գումար</span>
                            <form action="AutoCalulate" method="post" name="SortingTimeDescAmount">
                            ...
                            <form action="AutoCalulate" method="post" name="SortingTimeAsecAmount">
                                <input name="MaxAmount" value="<%=request.getParameter("MaxAmount")%>" type="hidden">
                                <input name="City" value="<%=request.getParameter("City")%>" type="hidden">
                                <input name="Currancy" value="<%=request.getParameter("Currancy")%>" type="hidden">
                                <input name="PageToGo" value="<%=request.getAttribute("PageToGo")%>" type="hidden">
                                                ...
                                                <div class="table">
                                                    <div class="table-row">
                                                        ...
                                                        <div class="table-cell">
                                                            ...
                                                            <%!
                                                                long entamenVjarumHavasar2(long Amount, double percentage, long Months) {
                                                                    ...
                                                                    double monthlyRate = percentage / 12.0;
                                                                    long termInMonths = Months;
                                                                    double monthlyPayment = (finalAmount * monthlyRate) / (1 - Math.pow(1 + monthlyRate, -termInMonths));
                                                                    return (long) monthlyPayment;
                                                                }
                                                            %>
                                                            <c:set var="SecondAmount" value='<%=discountingAmount2(AmountMain,percentageForDiscount2)%>' scope="request"/>
                                                            <%
                                                                long month = 0;
                                                                secoundAmount = 0;
                                                               /* if(request.getAttribute("SecondAmount") != null) {
                                                                    secoundAmount = Long.parseLong(String.valueOf(request.getAttribute("SecondAmount")));
                                                                }else*/ if(request.getAttribute("RangeTwo")  != null){
                                                        ...
                                                        <div class="table-cell text-center last">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                    <a href="CreditSend?ProductCode=${firstDepo.productCode}&&percentageSecond=<%=request.getParameter("percentageSecond")%>&&months=<%=request.getAttribute("months")%>&&PageToGo=Cars&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&MaxAmount=<%=request.getParameter("MaxAmount")%>&&range_two=<%=discountingAmount(discountAmount,percentageForDiscount)%>&&Amount=<%=request.getAttribute("range")%>"
                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                        ավելին</a>
                                                                    <a href="AutoCalulate?id=${firstDepo.productCode}&&percentageSecond=<%=request.getAttribute("percentageSecond")%>&&range_two=<%=request.getAttribute("RangeTwo")%>&&months=<%=request.getParameter("months")%>&&MaxAmount=<%=request.getParameter("MaxAmount")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getParameter("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                ...
                <div class="padding-bt-60">
                    <div class="inner-container">
						...
						<span class="tab-link" onclick="openTabItem(event, 'deposit')">
                           Ավանդներ</span>
                                <span class="tab-link active" onclick="openTabItem(event, 'mortgage')">
                        Հիպոթեկային վարկ</span>
                                <span class="tab-link" onclick="openTabItem(event, 'consumer-loan')">
                   Սպառողական վարկ</span>
                                <span class="tab-link" onclick="openTabItem(event, 'car-loan')" id="defaultOpen">
                    Ավտովարկ</span>
                                            ...
                                            <c:if test="${requestScope.depositListOffer!=null}">
                                                <c:forEach items="${requestScope.depositListOffer}"
                                                    ...
                                                    <div class="special-offer-item">
                                                        ...
                                                        <div>
                                                            <div class="item-img"
                                                                 style="background-image: url('${SpecialDeposit.banksList}')">
                                                            </div>
                                                            <div>
                                                    ...
                                                    <div class="special-offer-item">
                                                        ...
                                                        <div>
                                                            ...
                                                            <form action="CreditSend" method="get">
                                                                ...
                                                                <input type="hidden" name="percentageSecond"
                                                                       value="10"/>
