                         ...
                         <div class="tooltip">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="ConsumerBanks" method="post" name="Delete">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="ConsumerBanks" method="post" name="DeleteHipotek">
                            ...
                            <ul>
                                <li>
                                  ...
                                  <form action="ConsumerBanks" method="post" name="DeleteConsumer">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="ConsumerBanks" method="post" name="DeleteCar">
                           ...
                           <%-- <form action="CompareMicro" method="post" name="MicroCompare">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="ConsumerBanks" method="post" name="DeleteAG">
                            ...
                            <div class="table hide-for-mb">
                                <div class="table-row head sorting">
                                    ...
                                    <div class="table-cell">
                                        ...
                                        <form action="ConsumerBanks" method="post" name="SortingPercentageDesc">
                                        ...
                                        <form action="ConsumerBanks" method="post" name="SortingPercentageAsec">
                                            <input type="hidden" name="bankId" value='<%=request.getParameter("bankId")%>'/>
                                    ...
                                    <div class="table-cell item-img">
                                        ...
                                        <c:if test="${requestScope.depositList != null}">
                                            <c:forEach var="firstDepo" items="${requestScope.depositList}"
                                                       varStatus="loop">
                                                <c:set var="percentageMain" value="${firstDepo.CCFactual}"
                                                       scope="request"/>
                                                <c:set value="${firstDepo.bankId}" var="bank"/>
                                                <c:set value="${firstDepo.orderOfAppearance}" var="apperance"/>
                                                <c:set value="${firstDepo.CCMinAmount}" var="minAmount" scope="request"/>
                                                <c:set value="${firstDepo.CCMinPeriodMonth}" var="months"
                                                       scope="request"/>
                                                                    ...
                                                                    <div class="table-cell text-center last">
                                                                        ...
                                                                        <c:choose>
                                                                            <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                                <a href="CreditSend?ProductCode=${firstDepo.productCode}&&months=${firstDepo.CCMinPeriodMonth}&&MaxAmount=${firstDepo.CCMaxAmount}&&City=<%=request.getAttribute("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=Consumer&&Amount=${firstDepo.CCMinAmount}&&PageName=Consumer"
                                                                                   class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                                    ավելին</a>
                                                                                <a href="ConsumerCalculate?bankId=${firstDepo.bankId}&&id=${firstDepo.productCode}&&MaxAmounr=${firstDepo.CCMaxAmount}&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=ConsumerBank&&months=${firstDepo.CCMinPeriodMonth}&&Amount=${firstDepo.CCMinAmount}&&PageName=Consumer"
