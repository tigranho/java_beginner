...
<c:choose>
    <c:when test="${currancyCheck == 'AMD' && ChasBackTypeCheck == 'OFF' && DepitTypeCheck == 'depit' && FreeTypeCheck == 'OFF' && PeriodTypeCheck == 'OFF' && CreditTypeCheck == 'OFF'}">
        ...
        <sql:query dataSource="${dbdb1}" var="rsrs1">
            SELECT * FROM cardcontroller WHERE currancy = 'AMD' AND cardtype ='Դեբետ';
        </sql:query>
...
<c:choose>
    <c:when test="${currancyCheck == 'AMD' && ChasBackTypeCheck == 'OFF' && DepitTypeCheck == 'OFF' && FreeTypeCheck == 'free' && PeriodTypeCheck == 'OFF' && CreditTypeCheck == 'OFF'}">
        ...
        <sql:query dataSource="${dbdb2}" var="rsrs2">
            SELECT * FROM cardcontroller WHERE currancy = 'AMD' AND cardtype ='Անվճար';
        </sql:query>
...
<c:choose>
    <c:when test="${currancyCheck == 'AMD' && ChasBackTypeCheck == 'OFF' && DepitTypeCheck == 'OFF' && FreeTypeCheck == 'OFF' && PeriodTypeCheck == 'Periods' && CreditTypeCheck == 'OFF'}">
        ...
        <sql:query dataSource="${dbdb3}" var="rsrs3">
            SELECT * FROM cardcontroller WHERE currancy = 'AMD' AND cardtype ='Արտոնյալ ժամանակաշրջան';
        </sql:query>
...
<c:choose>
    <c:when test="${currancyCheck == 'AMD' && ChasBackTypeCheck == 'OFF' && DepitTypeCheck == 'OFF' && FreeTypeCheck == 'OFF' && PeriodTypeCheck == 'OFF' && CreditTypeCheck == 'crediting'}">
        ...
        <sql:query dataSource="${dbdb4}" var="rsrs4">
            SELECT * FROM cardcontroller WHERE currancy = 'AMD' AND cardtype ='Քրեդիտ';
        </sql:query>
