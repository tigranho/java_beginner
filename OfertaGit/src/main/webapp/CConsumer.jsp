        ...
        <div class="inner-container">
            <div class="compare-table flex-table">
                <div class="flex align-items-center head">
                    ...
                    <span class="flex align-items-center">
                        ...
                        <span class="font-16 bold padding-left-15">Սպառողական վարկեր</span>
                    </span>
                    </div>
                         ...
                         <span>
                           ...
                           <c:if test="${requestScope.BanksList != null}">
                            ...
                            <p class="margin-top-20"><a href="#"
                                    ...
                                    <span class="delete">
                                        <a class="icon-trash"
                                           href="CompareConsumer?IDToRemove=${compare.idCheck}&&Currancy=<%= request.getParameter("Currancy")%>&&clientCode=${compare.SID}"></a>
                                ...
                                <div class="def-input int-dashed">
                                    ...
                                    <c:choose>
                                        <c:when test="${currancy == 'AMD'}">
                                            <form action="CompareConsumer" method="post"
                ...
                <form action="CompareConsumer" name="compareNewAmount" type="get">
                    <div class="flex align-items-center">
                        <div class="flex-item">
            ...
            <div class="flex align-items-center">
                ...
                <c:if test="${requestScope.consumerCreditsCompareList != null}">
                    <c:forEach var="compare" items="${requestScope.consumerCreditsCompareList}">
                        <div class="flex-item">
                            <h3 class="timer count-title count-number bold blue" data-to="${compare.service}"
                                data-speed="1739"></h3>
                                <%-- <p>${compare.service}</p>--%>
                        </div>
                    </c:forEach>
                ...
                <c:if test="${requestScope.consumerCreditsCompareList != null}">
                    <c:forEach var="compare" items="${requestScope.consumerCreditsCompareList}">
                        ...
                        <div class="flex-item">
                            ...
                            %>
                            <c:forEach items="${requestScope.ConsumerMainList}" var="perceentage">
                                <c:set var="id" scope="request" value="${perceentage.productCode}"/>
                                <c:set var="percentage" scope="request" value="${perceentage.CCFactual}"/>
                                <c:choose>
            ...
            <div class="flex align-items-center">
                ...
                <c:if test="${requestScope.consumerCreditsCompareList != null}">
                    <c:forEach var="compare" items="${requestScope.consumerCreditsCompareList}">
                        ...
                        <c:set var="serviceCompare" value="${compare.service}" scope="request"/>
                        <%
                            ...
                            service2 = Integer.parseInt(String.valueOf(request.getAttribute("serviceCompare")));
                        ...
                        <div class="flex-item">
                            <h3 class="timer count-title count-number bold blue"
                                ...
                                data-speed="1739"></h3>
                                <%-- <p><%=calculatePercentage(Amount, percent, month) %>
                                 </p>--%>
                        </div>
                    </c:forEach>
                </c:if>
