                         ...
                         <div class="tooltip">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="AutoBanks" method="post" name="Delete">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="AutoBanks" method="post" name="DeleteHipotek">
                            ...
                            <ul>
                                <li>
                                  ...
                                  <form action="AutoBanks" method="post" name="DeleteConsumer">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="AutoBanks" method="post" name="DeleteCar">
                           ...
                           <%-- <form action="CompareMicro" method="post" name="MicroCompare">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="AutoBanks" method="post" name="DeleteAG">
                            ...
                            <div class="table hide-for-mb">
                                <div class="table-row head sorting">
                                    ...
                                    <div class="table-cell">
                                        ...
                                        <form action="AutoBanks" method="post" name="SortingPercentageDesc">
                                        ...
                                        <form action="AutoBanks" method="post" name="SortingPercentageAsec">
                                            <input type="hidden" name="bankId" value='<%=request.getParameter("bankId")%>'/>
                                    ...
                                    <div class="table-cell item-img">
                                        ...
                                        <c:if test="${requestScope.depositList != null}">
                                            <c:forEach var="firstDepo" items="${requestScope.depositList}"
                                                       varStatus="loop">
                                                <c:set var="percentageMain" value="${firstDepo.CLFatual}"
                                                       scope="request"/>
                                                <c:set value="${firstDepo.bankId}" var="bank"/>
                                                <c:set value="${firstDepo.orderOfAppearance}" var="apperance"/>
                                                <c:set value="${firstDepo.CLMinAmount}" var="minAmount" scope="request"/>
                                                <c:set value="${firstDepo.CLMinPeriodMonths}" var="months"
                                                       scope="request"/>
                                            ...
                                            return (int) AmountToPay;
                                                                                    ...
                                                                                    int month = Integer.parseInt(String.valueOf(request.getAttribute("months")));
                                                                    ...
                                                                    <div class="table-cell text-center last">
                                                                        ...
                                                                        <c:choose>
                                                                            <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                                <a href="CreditSend?ProductCode=${firstDepo.productCode}&&months=${firstDepo.CLMinPeriodMonths}&&MaxAmount=${firstDepo.CLMaxAmount}&&City=<%=request.getAttribute("City")%>&&Currancy=${firstDepo.currancy}&&PageToGo=Cars&&Amount=${firstDepo.CLMinAmount}&&PageName=Car"
                                                                                   class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                                    ավելին</a>
                                                                                <a href="AutoCalulate?bankId=${firstDepo.bankId}&&id=${firstDepo.productCode}&&MaxAmounr=${firstDepo.CLMaxAmount}&&City=<%=request.getParameter("City")%>&&Currancy=${firstDepo.currancy}&&PageToGo=Cars&&months=${firstDepo.CLMinPeriodMonths}&&Amount=${firstDepo.CLMinAmount}&&PageName=Car"
                                            ...
                                            <div class="table-cell item-img">
                                                ...
                                                <c:if test="${requestScope.deposiOposit != null}">
                                                    <c:forEach var="firstDepo" items="${requestScope.deposiOposit}"
                                                        ...
                                                        <c:set value="${firstDepo.orderOfAppearance}" var="apperance"/>
                                                        <c:set value="${firstDepo.CLMinAmount}" var="minAmount" scope="request"/>
                                                        <c:set value="${firstDepo.CLMinPeriodMonths}" var="months" scope="request"/>
