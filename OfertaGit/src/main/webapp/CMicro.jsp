        ...
        <div class="inner-container">
            <div class="compare-table flex-table">
                <div class="flex align-items-center head">
                    ...
                    <span class="flex align-items-center">
                        ...
                        <span class="font-16 bold padding-left-15">Միկրովարկ</span>
                    </span>
                    </div>
                        ...
                        <c:forEach var="compare" items="${requestScope.consumerCreditsCompareList}">
                         ...
                         <span>
                            ...
                            <p class="margin-top-20"><a href="#"
                                    ...
                                    <span class="delete">
                                        <a class="icon-trash"
                                           href="CompareMicro?IDToRemove=${compare.idCheck}&&Currancy=<%= request.getParameter("Currancy")%>&&clientCode=${compare.SID}"></a>
                ...
                <div class="flex align-items-center">
                    ...
                    <c:if test="${requestScope.consumerCreditsCompareList != null}">
                        <c:forEach var="compare" items="${requestScope.consumerCreditsCompareList}"
                            ...
                            <c:set value="${compare.amount}" var="amoutig" scope="request"/>
                            <%!
                                static int amountig;
                            %>
                            <%
                                amountig = Integer.parseInt(String.valueOf(request.getAttribute("amoutig")));
                            %>
                            <div class="flex-item">
                                <div class="def-input int-dashed">
                                    ...
                                    <c:choose>
                                        <c:when test="${currancy == 'AMD'}">
                                            <form action="CompareMicro" method="post" name="amountSectionform"
                ...
                <form action="CompareMicro" name="compareNewAmount" type="get">
                    <div class="flex align-items-center">
                        <div class="flex-item">
            ...
            <div class="flex align-items-center">
                ...
                <c:if test="${requestScope.consumerCreditsCompareList != null}">
                    <c:forEach var="compare" items="${requestScope.consumerCreditsCompareList}">
                        <div class="flex-item">
                            <h2 class="timer count-title count-number bold blue" data-to="${compare.service}"
                                data-speed="1739"></h2>
                    ...
                    <c:forEach var="compare" items="${requestScope.consumerCreditsCompareList}"
                        ...
                        <div class="flex-item">
                            <form action="CreditSend" method="post" name="formsend">
                                ...
                                <input type="hidden" name="range${TheCount.count}" value="${compare.amount}">
                                <input type="hidden" name="percentage${TheCount.count}"
                                       value="${compare.percentage}">
