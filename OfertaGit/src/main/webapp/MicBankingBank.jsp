                         ...
                         <div class="tooltip">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="MicroBanks" method="post" name="Delete">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="MicroBanks" method="post" name="DeleteHipotek">
                            ...
                            <ul>
                                <li>
                                  ...
                                  <form action="MicroBanks" method="post" name="DeleteConsumer">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="MicroBanks" method="post" name="DeleteCar">
                           ...
                           <%-- <form action="CompareMicro" method="post" name="MicroCompare">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="MicroBanks" method="post" name="DeleteAG">
                            ...
                            <div class="table hide-for-mb">
                                <div class="table-row head sorting">
                                    ...
                                    <div class="table-cell">
                                        ...
                                        <form action="MicroBanks" method="post" name="SortingPercentageDesc">
                                        ...
                                        <form action="MicroBanks" method="post" name="SortingPercentageAsec">
                                            <input type="hidden" name="bankId" value='<%=request.getParameter("bankId")%>'/>
                                            <input name="Currancy" value="<%=request.getParameter("Currancy")%>"
                                                   type="hidden">
                                    ...
                                    <div class="table-cell item-img">
                                        ...
                                        <c:if test="${requestScope.depositList != null}">
                                            <c:forEach var="firstDepo" items="${requestScope.depositList}"
                                                       varStatus="loop">
                                                <c:set var="percentageMain" value="${firstDepo.MLFatual}"
                                                       scope="request"/>
                                                <c:set value="${firstDepo.bankId}" var="bank"/>
                                                <c:set value="${firstDepo.orderOfAppearance}" var="apperance"/>
                                                <c:set value="${firstDepo.MLMinAmount}" var="minAmount" scope="request"/>
                                                <c:set value="${firstDepo.MMinPeriodDays}" var="months"
                                                       scope="request"/>
                                                                    ...
                                                                    <div class="table-cell text-center last">
                                                                        ...
                                                                        <c:choose>
                                                                            <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                                <a href="CreditSend?id=${firstDepo.productCode}&&months=${firstDepo.MMinPeriodDays}&&MaxAmount=${firstDepo.MLMaxAmount}&&City=<%=request.getAttribute("City")%>&&Currancy=${firstDepo.currancy}&&PageToGo=Micro&&Amount=${firstDepo.MLMinAmount}&&PageName=Micro"
                                                                                   class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                                    ավելին</a>
                                                                                <a href="CalculatMocri?id=${firstDepo.MLId}&&bankId=${firstDepo.bankId}&&MaxAmounr=${firstDepo.MLMaxAmount}&&City=<%=request.getParameter("City")%>&&Currancy=${firstDepo.currancy}&&PageToGo=MicroBank&&months=${firstDepo.MMinPeriodDays}&&Amount=${firstDepo.MLMinAmount}&&PageName=MicroBank"
                                                                                ...
                                                                                <c:choose>
                                                                                    <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                                        <a href="CreditSend?id=${firstDepo.productCode}&&months=${firstDepo.MMinPeriodDays}&&MaxAmount=${firstDepo.MLMaxAmount}&&City=<%=request.getAttribute("City")%>&&Currancy=${firstDepo.currancy}&&PageToGo=Micro&&Amount=${firstDepo.MLMinAmount}&&PageName=Micro"
                                                                                           class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                                            ավելին</a>
                                                                                        <a href="CalculatMocri?bankId=${firstDepo.bankId}&&bankId=${firstDepo.bankId}&&id=${firstDepo.productCode}&&MaxAmounr=${firstDepo.MLMaxAmount}&&City=<%=request.getParameter("City")%>&&Currancy=${firstDepo.currancy}&&PageToGo=MicroBank&&months=${firstDepo.MMinPeriodDays}&&Amount=${firstDepo.MLMinAmount}&&PageName=MicroBank"
                                                                                           class="blue-link font-12">Համեմատել</a>
                                                                                        <%--  <p><a href="index.php?page=compare/deposit"
                                                                                                class="blue-link font-12">Համեմատել</a></p>--%>
