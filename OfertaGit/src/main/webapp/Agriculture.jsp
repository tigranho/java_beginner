                    ...
                    <div class="right flex align-items-center">
                     ...
                     <span class="compere-icon" onclick="toggleBoxes('compareTooltipMb')">
                        <c:if test="${requestScope.comparListAg != null}">
                            <c:forEach var="size" items="${requestScope.comparListAg}" varStatus="TheCount">
                                <span class="count"><c:out value="${TheCount.count}"/></span>
                            </c:forEach>
                            <%--     <span class="count"><c:out value="${size}"/></span>--%>
                        </c:if>
                                ...
                                <li>
                                    ...
                                    <form action="DepositClient" method="get" name="Deletesmall">
                                        ...
                                        <input name="Currancy" value="<%=request.getParameter("Currancy")%>"
                                               type="hidden">
                                        <input name="PageToGo" value="AClient"
                                               type="hidden">
        ...
        <div class="bg" style="background-image: url('../images/5.jpg')">
            <div class="inner-container info-container">
                ...
                <div class="row-md clearfix">
                    <form name="main" action="AgCalculate" method="get">
                        ...
                        <div class="table">
                            <div class="table-row">
                                ...
                                <div class="table-cell">
                                    ...
                                    <p class="font-28 bold">${SpecialConsumer.ACFactual}%</p>
                                    <small>№ ${SpecialConsumer.productCode}</small>
                                </div>

                                <div class="table-cell">
                                        <%--  Մինչեւ ${SpecialConsumer.ACMaxPeriodMonth} Ամիս--%>

                                            <p class="font-24 bold"><fmt:formatNumber type="number"
                                                                                      maxFractionDigits="3"
                                                                                      value="${SpecialConsumer.ACMinAmount}"/>
                                                - <fmt:formatNumber type="number" maxFractionDigits="3"
                                                                    value="${SpecialConsumer.ACMaxAmount}"/></p>
                                ...
                                <div class="table-cell text-center">
                                    ...
                                    <a href="CreditSend?ProductCode=${SpecialConsumer.productCode}&&Per=${SpecialConsumer.ACFactual}&&months=0&&Amount=<%=request.getAttribute("range")%>&&PageToGo=AG&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&value_two=<%=request.getAttribute("minAmount")%>&&range_two=30"
                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ ավելին</a>
                                    <p>
                                        <a href="AClient?id=${SpecialConsumer.productCode}&&months=0&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <form action="AClient" method="get" name="SortingPercentageDesc">
                            ...
                            <form action="AClient" method="get" name="SortingPercentageAsec">
                        ...
                        <div class="table-cell">
                            ...
                            <span>Գումար</span>
                            <form action="AClient" method="get" name="SortingPercentageDescAmount">
                            ...
                            <form action="AClient" method="get" name="SortingPercentageAsecAmount">
                                                ...
                                                <div class="table">
                                                    <div class="table-row">
                                                                ...
                                                                <a class="green-link font-12 width-icon right-icon ellipsis"
                                                                   onclick="toggleSubSuggestions()">
                                                                    ...
                                                                    <sql:query dataSource="${db2}" var="count">
                                                                        SELECT * FROM agriculturalcreditcontroller ;
                                                                    </sql:query>
                                                                    <c:forEach var="counting" items="${count.rows}"
                                                                               varStatus="TheCount">
                                                                        <c:set var="currancy"
                                                                               value="${counting.currancy}"/>
                                                        ...
                                                        <div class="table-cell">
                                                            ...
                                                            <p>${firstDepo.ACFactual}%</p>
                                                            <small>№ ${firstDepo.productCode}</small>
                                                        </div>


                                                        <div class="table-cell">
                                                                <%-- Մինչեւ ${firstDepo.ACMaxPeriodMonth} Ամիս--%>

                                                                    <p class="font-24 bold"><fmt:formatNumber
                                                                            type="number" maxFractionDigits="3"
                                                                            value="${firstDepo.ACMinAmount}"/>-
                                                                        <fmt:formatNumber type="number"
                                                                                          maxFractionDigits="3"
                                                                                          value="${firstDepo.ACMaxAmount}"/></p>
                                                        ...
                                                        <div class="table-cell text-center last">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                    <a href="CreditSend?ProductCode=${firstDepo.productCode}&&Per=${firstDepo.ACFactual}&&months=0&&Amount=<%=request.getAttribute("range")%>&&PageToGo=AG&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&value_two=<%=request.getAttribute("minAmount")%>&&range_two=30"
                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                        ավելին</a>
                                                                    <a href="AClient?id=${firstDepo.productCode}&&months=0&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                            ...
                                                            <td>
                                                                ...
                                                                <c:forEach var="seconDepo" items="${rs.rows}"
                                                                    ...
                                                                    <c:set value="${seconDepo.orderOfAppearance}"
                                                                           var="orderOfAppearance"/>
                                                                    <c:set value="${seconDepo.currancy}"
                                                                           var="currancy2"/>
                                                                                ...
                                                                                <div class="table">
                                                                                    <div class="table-row">
                                                                                        ...
                                                                                        <div class="table-cell">
                                                                                            ...
                                                                                            <p class="font-28 bold">${seconDepo.ACFactual}%</p>
                                                                                            <small>№ ${seconDepo.productCode}</small>
                                                                                        </div>
                                                                                        <div class="table-cell">
                                                                                                <%-- <p>Մինչեւ ${seconDepo.ACMaxPeriodMonth} Ամիս</p>--%>
                                                                                                    ...
                                                                                                    <p class="font-24 bold">
                                                                                                        <fmt:formatNumber
                                                                                                                type="number"
                                                                                                                maxFractionDigits="3"
                                                                                                                value="${seconDepo.ACMinAmount}"/>
                                                                                                        -
                                                                                                        <fmt:formatNumber
                                                                                                                type="number"
                                                                                                                maxFractionDigits="3"
                                                                                                                value="${seconDepo.ACMaxAmount}"/>
                                                                                                    </p>
                                                                                        ...
                                                                                        <div class="table-cell text-center">
                                                                                            ...
                                                                                            <c:choose>
                                                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                                                    <a href="CreditSend?ProductCode=${seconDepo.productCode}&&Per=${seconDepo.ACFactual}&&months=0&&Amount=<%=request.getAttribute("range")%>&&PageToGo=AG&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getAttribute("Currancy")%>&&value_two=<%=request.getAttribute("minAmount")%>&&range_two=30"
                                                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                                                        ավելին</a>

                                                                                                    <a href="AClient?id=${seconDepo.productCode}&&months=0&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Mortgage"
                                                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                                                                    <%--<p>
                                                                                                ...
                                                                                                <c:when test="${gotoPage == 0 && sendRequest==0  && lastLogic == 1}">
                                                                                                    ...
                                                                                                    <a href="AClient?id=${seconDepo.productCode}&&months=0&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getParameter("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Mortgage"
                                                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                                                                                    <%-- <p>
                                                                                                         <a href="index.php?page=compare/deposit"
                                                                                                            class="blue-link font-12">Համեմատել</a>
                ...
                <div class="inner-container">
                    ...
                    <div class="tab-container">
                        ...
                        Հիպոթեկային վարկ</span>
                            <span class="tab-link active" onclick="openTabItem(event, 'consumer-loan')">
                   Սպառողական վարկ</span>
                            <span class="tab-link" onclick="openTabItem(event, 'car-loan')">
                    Ավտովարկ</span>
                            <span class="tab-link" onclick="openTabItem(event, 'agricultural')" id="defaultOpen">
                                        ...
                                        <c:if test="${requestScope.MortgageListOffer!=null}">
                                            <c:forEach items="${requestScope.MortgageListOffer}"
                                                ...
                                                <div class="special-offer-item">
                                                    ...
                                                    <div>
                                                        <c:set value="${SpecialMortgage.MMinPeriodMonth}" var="monthS"
                                                               scope="request"/>
                                                        <%
