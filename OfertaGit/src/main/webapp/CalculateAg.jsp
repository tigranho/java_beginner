                                ...
                                <li>
                                    ...
                                    <form action="DepositClient" method="post" name="Deletesmall">
                                        ...
                                        <input name="Currancy" value="<%=request.getParameter("Currancy")%>"
                                               type="hidden">
                                        <input name="PageToGo" value="ACaluclate"
                                               type="hidden">
        ...
        <div class="bg" style="background-image: url('../images/5.jpg')">
            <div class="inner-container info-container">
                ...
                <div class="row-md clearfix">
                    <form name="main" action="AgCalculate" method="post">
                        ...
                        <div class="table">
                            <div class="table-row">
                                ...
                                <div class="table-cell">
                                    ...
                                    <p class="font-24 bold">${SpecialConsumer.ACFactual}%</p>
                                    <c:set var="percentage" value="${SpecialConsumer.ACFactual}" scope="request"/>
                                ...
                                <div class="table-cell">
                                    ...
                                    <%
                                        ...
                                        if (request.getParameter("months") != null && !request.getParameter("months").equals("0")) {
                                            monthMain = Integer.parseInt(request.getParameter("months"));//1
                                        } else {
                                            monthMain = Integer.parseInt(String.valueOf(request.getAttribute("months")));//1
                                        }
                                    %>
                                    <c:set value="${requestScope.PageCurrancy}" var="curancy2"/>
                                    <c:choose>
                                        <c:when test="${curancy2 == 'AMD'}">
                                            <h2 class="timer count-title count-number font-28 bold"
                                                data-to="<%=entamenVjarumHavasar(AmountMain, percentMain, monthMain) %>"
                                                data-speed="1739"></h2>
                                        </c:when>
                                        <c:when test="${curancy2 == 'USD'}">
                                            <h2 class="timer count-title count-number font-28 bold"
                                                data-to="<%=entamenVjarumHavasar(AmountMain, percentMain, monthMain) %>"
                                                data-speed="1739"></h2>
                                        </c:when>
                                        <c:when test="${curancy2 == 'RUB'}">
                                            <h2 class="timer count-title count-number font-28 bold"
                                                data-to="<%=entamenVjarumHavasar(AmountMain, percentMain, monthMain) %>"
                                                data-speed="1739"></h2>
                                        </c:when>
                                        <c:when test="${curancy2 == 'EUR'}">
                                            <h2 class="timer count-title count-number font-28 bold"
                                                data-to="<%=entamenVjarumHavasar(AmountMain, percentMain, monthMain) %>"
                                                data-speed="1739"></h2>
                                        </c:when>
                                ...
                                <div class="table-cell text-center">
                                    ...
                                    <a href="CreditSend?id=${SpecialConsumer.productCode}&&months=<%=request.getParameter("months")%>&&MaxAmount=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=AG"
                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ ավելին</a>
                                    <p>
                                        <a href="AgCalculate?id=${SpecialConsumer.productCode}&&months=<%=request.getParameter("months")%>&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getParameter("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <form action="AgCalculate" method="post" name="SortingPercentageDesc">
                            ...
                            <form action="AgCalculate" method="post" name="SortingPercentageAsec">
                        ...
                        <div class="table-cell item-img">
                            ...
                            <c:if test="${requestScope.depositAllInRage != null}">
                                <c:forEach var="firstDepo" items="${requestScope.depositAllInRage}" varStatus="loop">
                                    <c:set var="percentageMain" value="${firstDepo.ACFactual}" scope="request"/>
                                    ...
                                    <table class="fold-table">
                                        ...
                                        <tr class="view">
                                                ...
                                                <div class="table">
                                                    <div class="table-row">
                                                        ...
                                                        <div class="table-cell">
                                                            ...
                                                            <p class="font-24 bold">${firstDepo.ACFactual}%</p>
                                            ...
                                            monthMain = Integer.parseInt(String.valueOf(request.getAttribute("months")));//1
                                                            ...
                                                            <h2 class="timer count-title count-number font-28 bold"
                                                                data-to="<%=entamenVjarumHavasar2(Amount, percent, monthMain)%>"
                                                                data-speed="1739"></h2>
                                                            </c:when>
                                                        ...
                                                        <div class="table-cell text-center last">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                    ...
                                                                    <a href="CreditSend?id=${firstDepo.productCode}&&months=<%=request.getParameter("months")%>&&MaxAmount=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getAttribute("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=AG"
                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                        ավելին</a>
                                                                    <a href="AgCalculate?id=${firstDepo.productCode}&&months=<%=request.getParameter("months")%>&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getParameter("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
