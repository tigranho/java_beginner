                         ...
                         <div class="tooltip">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="AgBanks" method="post" name="Delete">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="AgBanks" method="post" name="DeleteHipotek">
                            ...
                            <ul>
                                <li>
                                  ...
                                  <form action="AgBanks" method="post" name="DeleteConsumer">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="AgBanks" method="post" name="DeleteCar">
                           ...
                           <%-- <form action="CompareMicro" method="post" name="MicroCompare">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="AgBanks" method="post" name="DeleteAG">
                            ...
                            <div class="table hide-for-mb">
                                <div class="table-row head sorting">
                                    ...
                                    <div class="table-cell">
                                        ...
                                        <form action="AgBanks" method="post" name="SortingPercentageDesc">
                                        ...
                                        <form action="AgBanks" method="post" name="SortingPercentageAsec">
                                            <input type="hidden" name="bankId" value='<%=request.getParameter("bankId")%>'/>
                                            <input name="Currancy" value="<%=request.getParameter("Currancy")%>"
                                                   type="hidden">
                                    ...
                                    <div class="table-cell item-img">
                                        ...
                                        <c:if test="${requestScope.depositList != null}">
                                            <c:forEach var="firstDepo" items="${requestScope.depositList}"
                                                       varStatus="loop">
                                                <c:set var="percentageMain" value="${firstDepo.ACFactual}"
                                                       scope="request"/>
                                                <c:set value="${firstDepo.bankId}" var="bank"/>
                                                <c:set value="${firstDepo.orderOfAppearance}" var="apperance"/>
                                                <c:set value="${firstDepo.ACMinAmount}" var="minAmount" scope="request"/>
                                                <c:set value="${firstDepo.ACMinPeriodMonth}" var="months"
                                                       scope="request"/>
                                                                    ...
                                                                    <div class="table-cell text-center last">
                                                                        ...
                                                                        <c:choose>
                                                                            <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                                <a href="CreditSend?ProductCode=${firstDepo.productCode}&&months=${firstDepo.ACMinPeriodMonth}&&MaxAmount=${firstDepo.ACMaxAmount}&&City=<%=request.getAttribute("City")%>&&Currancy=${firstDepo.currancy}&&PageToGo=AG&&Amount=${firstDepo.ACMinAmount}&&PageName=AGBanks"
                                                                                   class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                                    ավելին</a>
                                                                                <a href="AgCalculate?bankId=${firstDepo.bankId}&&id=${firstDepo.productCode}&&MaxAmounr=${firstDepo.ACMaxAmount}&&City=<%=request.getParameter("City")%>&&Currancy=${firstDepo.currancy}&&PageToGo=AGBanks&&months=${firstDepo.ACMinPeriodMonth}&&Amount=${firstDepo.ACMinAmount}&&PageName=AGBanks"
