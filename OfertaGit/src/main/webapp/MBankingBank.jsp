                         ...
                         <div class="tooltip">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="About" method="post" name="Delete">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="About" method="post" name="DeleteHipotek">
                            ...
                            <ul>
                                <li>
                                  ...
                                  <form action="About" method="post" name="DeleteConsumer">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="About" method="post" name="DeleteCar">
                           ...
                           <%-- <form action="CompareMicro" method="post" name="MicroCompare">
                            ...
                            <ul>
                                <li >
                                 ...
                                 <form action="About" method="post" name="DeleteAG">
                            ...
                            <div class="table hide-for-mb">
                                <div class="table-row head sorting">
                                    ...
                                    <div class="table-cell">
                                        ...
                                        <form action="MortgageBanks" method="post" name="SortingPercentageDesc">
                                        ...
                                        <form action="MortgageBanks" method="post" name="SortingPercentageAsec">
                                            <input type="hidden" name="bankId" value='<%=request.getParameter("bankId")%>'/>
                                    ...
                                    <div class="table-cell item-img">
                                        ...
                                        <c:if test="${requestScope.depositList != null}">
                                            <c:forEach var="firstDepo" items="${requestScope.depositList}"
                                                       varStatus="loop">
                                                <c:set var="percentageMain" value="${firstDepo.MFatual}"
                                                       scope="request"/>
                                                <c:set value="${firstDepo.bankId}" var="bank"/>
                                                <c:set value="${firstDepo.orderOfAppearance}" var="apperance"/>
                                                <c:set value="${firstDepo.MMinAmount}" var="minAmount" scope="request"/>
                                                <c:set value="${firstDepo.MMinPeriodMonth}" var="months"
                                                       scope="request"/>
                                                                    ...
                                                                    <div class="table-cell text-center last">
                                                                        ...
                                                                        <c:choose>
                                                                            <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                                <a href="CreditSend?ProductCode=${firstDepo.productCode}&&months=${firstDepo.MMinPeriodMonth}&&MaxAmount=${firstDepo.MMaxAmount}&&City=<%=request.getAttribute("City")%>&&Currancy=${firstDepo.currancy}&&PageToGo=Mortgage&&Amount=${firstDepo.MMinAmount}&&PageName=Mortgage"
                                                                                   class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                                    ավելին</a>
                                                                                <a href="CalculateMort?bankId=${firstDepo.bankId}&&id=${firstDepo.productCode}&&MaxAmounr=${firstDepo.MMaxAmount}&&City=<%=request.getParameter("City")%>&&Currancy=${firstDepo.currancy}&&PageToGo=MortgageBank&&months=${firstDepo.MMinPeriodMonth}&&Amount=${firstDepo.MMinAmount}&&PageName=MortgageBank"
                                                                        ...
                                                                        <div class="table-row">
                                                                            ...
                                                                            <div class="table-cell">
                                                                                ...
                                                                                <p >
                                                                                     ...
                                                                                     month = Integer.parseInt(String.valueOf(request.getAttribute("months")));
                                                                            ...
                                                                            <div class="table-cell text-center last">
                                                                                ...
                                                                                <c:choose>
                                                                                    <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                                        <a href="CreditSend?ProductCode=${firstDepo.productCode}&&months=${firstDepo.MMaxPeriodMonth}&&MaxAmount=${firstDepo.MMaxAmount}&&City=<%=request.getAttribute("City")%>&&Currancy=${firstDepo.currancy}&&PageToGo=Mortgage&&Amount=${firstDepo.MMinAmount}&&PageName=Mortgage"
                                                                                           class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                                            ավելին</a>
                                                                                        <a href="CalculateMort?bankId=${firstDepo.bankId}&&id=${firstDepo.MId}&&MaxAmounr=${firstDepo.MMaxAmount}&&City=<%=request.getParameter("City")%>&&Currancy=${firstDepo.currancy}&&PageToGo=MortgageBank&&months=${firstDepo.MMaxPeriodMonth}&&Amount=${firstDepo.MMinAmount}&&PageName=MortgageBank"
                                                                                           class="blue-link font-12">Համեմատել</a>
                                                                                        <%--  <p><a href="index.php?page=compare/deposit"
                                                                                                class="blue-link font-12">Համեմատել</a></p>--%>
