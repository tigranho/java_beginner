                        ...
                        <div class="table">
                            <div class="table-row">
                                ...
                                <div class="table-cell">
                                    ...
                                    <p class="font-28 bold">${SpecialConsumer.MLFatual}%</p>
                                    ...
                                    <c:choose>
                                        <c:when test="${curancy == 'AMD'}">
                                            <p class="font-24 bold"><fmt:formatNumber type="number"
                                                                                      maxFractionDigits="3"
                                                                                      value="${SpecialConsumer.MLMinAmount}"/>
                                                - <fmt:formatNumber type="number" maxFractionDigits="3"
                                                                    value="${SpecialConsumer.MLMaxAmount}"/></p>
                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <form action="MicroClient" method="post" name="SortingPercentageDesc">
                            ...
                            <form action="MicroClient" method="post" name="SortingPercentageAsec">
                        ...
                        <div class="table-cell">
                            ...
                            <span>Գումար</span>
                            <form action="MicroClient" method="post" name="SortingPercentageDescAmount">
                            ...
                            <form action="MicroClient" method="post" name="SortingPercentageAsecAmount">
                                                ...
                                                <div class="table">
                                                    <div class="table-row">
                                                        ...
                                                        <div class="table-cell item-img">
                                                           ...
                                                           user="root" password="YLf{}cJ,Kvd%"/>--%>
                                                                    ...
                                                                    <sql:query dataSource="${db2}" var="count">
                                                                        SELECT * FROM microloancontroller ;
                                                                    </sql:query>
                                                        ...
                                                        <div class="table-cell">
                                                            ...
                                                            <p class="font-28 bold">${firstDepo.MLFatual}%</p>
                                                            <small>№ ${firstDepo.productCode}</small>
                                                        </div>


                                                        <div class="table-cell">
                                                                <%-- Մինչեւ ${firstDepo.MMaxPeriodDays} օր--%>
                                                            <c:set value="${requestScope.PageCurrancy}" var="curancy"/>
                                                            <c:choose>
                                                                <c:when test="${curancy == 'AMD'}">
                                                                    <p class="font-24 bold"><fmt:formatNumber
                                                                            type="number"
                                                                            maxFractionDigits="3"
                                                                            value="${firstDepo.MLMinAmount}"/>
                                                                        - <fmt:formatNumber type="number"
                                                                                            maxFractionDigits="3"
                                                                                            value="${firstDepo.MLMaxAmount}"/></p>
                                                                                ...
                                                                                <div class="table">
                                                                                    <div class="table-row">
                                                                                        ...
                                                                                        <div class="table-cell">
                                                                                            ...
                                                                                            <p class="font-28 bold">${seconDepo.MLFatual}%</p>
                                                                                            <small>
                                                                                        ...
                                                                                        <div class="table-cell">
                                                                                                <%-- Մինչեւ ${seconDepo.MMaxPeriodDays} oր--%>
