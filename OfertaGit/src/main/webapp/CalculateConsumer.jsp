                        ...
                        <div class="table">
                            <div class="table-row">
                                ...
                                <div class="table-cell">
                                        <%--    Գումար--%>
                                    <%!
                                        long calculatePercentageMain(long Amount, double Percentage, int month) {
                                            Percentage /= 100.0;
                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <form action="ConsumerCalculate" method="post" name="SortingPercentageDesc">
                            ...
                            <form action="ConsumerCalculate" method="post" name="SortingPercentageAsec">
                        ...
                        <div class="table-cell">
                            ...
                            <span>Գումար</span>
                            <%-- <form action="ConsumerCalculate" method="post" name="SortingTimeDescAmount">
                             ...
                             <form action="ConsumerCalculate" method="post" name="SortingTimeAsecAmount">
                                                    ...
                                                    <div class="table-row">
                                                        ...
                                                        <div class="table-cell">
                                                                <%--  <p>Գումար</p>--%>
                                                                        ...
                                                                        <%!
                                                                    long calculatePercentage(long Amount, double Percentage, int month) {
                                                                        Percentage /= 100.0;
                                            double monthlyRate = Percentage / 12.0;
                                            long termInMonths = month ;
                                            double monthlyPayment = (Amount * monthlyRate) / (1 - Math.pow(1 + monthlyRate, -termInMonths));
                ...
                <div class="padding-bt-60">
                    <div class="inner-container">
                        ...
                        Հիպոթեկային վարկ</span>
                                <span class="tab-link" onclick="openTabItem(event, 'consumer-loan')" id="defaultOpen">
