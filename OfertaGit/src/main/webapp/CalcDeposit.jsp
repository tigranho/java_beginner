        ...
        <div class="bg" style="background-image: url('../images/2.jpg')">
            <div class="inner-container info-container">
                ...
                <div class="row-md clearfix">
                    <form name="main" action="Calculate" method="post">
                        ...
                        <div class="col-4 middle col">
                            ...
                            <div class="def-select-box">
                                ...
                                <select name="months" id="select_month" onchange="document.main.submit();">
                                    <option value="1" <c:if test="${monthsSection == '1'}">selected</c:if>>1 ամիս
                                    </option>
                                    <option value="3" <c:if test="${monthsSection == '3'}">selected</c:if>>3 ամիս
                                    </option>
                                    <option value="6" <c:if test="${monthsSection == '6'}">selected</c:if>>6 ամիս
                                    </option>
                                    <option value="9" <c:if test="${monthsSection == '9'}">selected</c:if>>9 ամիս
                                    </option>
                    ...
                    <c:forEach items="${requestScope.depositeAseList}" var="SpecialDeposit">
                        <div class="table">
                            <div class="table-row">
                                ...
                                <%!
                                    static int monthmain;
                                %>

                                <%!
                                    double calculatePercentageMain(float Amount, double Percentage, int month) {
                                        double per = Percentage / 100;
                                        double firstStep = Amount * per;
                                        double secondStep = firstStep / 365;
                                        double finalStep2 = secondStep * 31;
                                        double result =finalStep2 * month;
                                        double finalResult = Amount + (result - (result * 0.10));
                                        return finalResult;
                                    }
                                %>
                                ...
                                <%
                                    ...
                                    monthmain = Integer.parseInt(String.valueOf(request.getParameter("months")));//1
                                %>
                                ...
                                <div class="table-cell">
                                    ...
                                    <c:when test="${curancy == 'USD'}">
                                        <h2 class="timer count-title count-number font-28 bold"
                                            data-to="<%=Amountmain + calculatePercentageMain(Amountmain, percentmain, monthmain) %>"
                                            data-speed="1739"></h2>
                                        <%-- <fmt:formatNumber type="number" maxFractionDigits="3"
                                                           value='<%=calculatePercentageMain(Amountmain, percentmain, monthmain) %>'/>--%>
                                    </c:when>
                                ...
                                <div class="table-cell text-center">
                                    ...
                                    <a href="Credits?ProductCode=${SpecialDeposit.productCode}&FromPageName=Deposit&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&range=<%=request.getAttribute("range")%>&&Currancy=<%=request.getParameter("Currancy")%>&&months=<%=monthmain*30%>&&value_two=0"
                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ ավելին</a>
                                    <p>
                                        <a href="Calculate?id=${SpecialDeposit.productCode}&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getParameter("PageToGo")%>&&months=<%=monthmain*30%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                        ...
                                        <a href="${SpecialDeposit.bankLink}"
                                           class="def-button btn-green with-shadow  margin-bottom-15" target="_blank">Անցնել
                                            էջ</a>
                                    <p>
                                        <a href="Calculate?id=${SpecialDeposit.productCode}&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getParameter("PageToGo")%>&&months=<%=monthmain%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                           class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                        ...
                                        <a href="Credits?ProductCode=${SpecialDeposit.productCode}&FromPageName=Deposit&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&range=<%=request.getAttribute("range")%>&&Currancy=<%=request.getParameter("Currancy")%>&&months=<%=monthmain%>&&value_two=0"
                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <form action="Calculate" method="post" name="SortingPercentageDesc">
                            ...
                            <form action="Calculate" method="post" name="SortingPercentageAsec">
                                    ...
                                    <table class="fold-table">
                                                    ...
                                                    <div class="table-row">
                                                        ...
                                                        <div class="table-cell">
                                                            ...
                                                            <p class="font-24 bold">
                                                                        ...
                                                                        <%!
                                                                    double calculatePercentage(double Amount, double Percentage, int month) {
                                                                   double per = Percentage / 100;
                                        double firstStep = Amount * per;
                                        double secondStep = firstStep / 365;
                                        double finalStep2 = secondStep * 31;
                                        ...
                                        return finalResult;
                                                        ...
                                                        <div class="table-cell text-center last">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                    <a href="Credits?ProductCode=${firstDepo.productCode}&FromPageName=Deposit&&MaxAmounr=<%=request.getParameter("MaxAmounr")%>&&range=<%=request.getAttribute("range")%>&&Currancy=<%=request.getParameter("Currancy")%>&&months=<%=request.getParameter("months")%>&&value_two=0"
                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                        ավելին</a>
