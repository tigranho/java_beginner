...
<div class="page-container">
    ...
    <div class="padding-bt-60 bg-white-dark">
        <div class="inner-container about-us-page">
            <p class="title font-24 line-height-36">Մեր մասին</p>
            <c:if test="${requestScope.aboutUsList != null}">
                <c:forEach var="about" items="${requestScope.aboutUsList}">
                    <c:set var="languages" value="${requestScope.Pagelanguage}"/>
                    <c:choose>
                        <c:when test="${languages == 'en_US'}">
                            <p class="title font-24 line-height-36 margin-top-100">${about.about_Eng}
                            </p>
                        </c:when>
                        <c:when test="${languages == 'hy_AM'}">
                            <p class="title font-24 line-height-36 margin-top-100">${about.about_arm}
                            </p>
                        </c:when>
                        <c:otherwise>
                            <p class="title font-24 line-height-36 margin-top-100">${about.about_Ru}
                            </p>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
