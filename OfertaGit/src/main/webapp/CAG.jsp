            ...
            <div class="compare-table flex-table">
                <div class="flex align-items-center head">
                    ...
                    <span class="flex align-items-center">
                        ...
                        <span class="font-16 bold padding-left-15">Գյուղատնտեսական վարկ</span>
                    </span>
                    </div>
                         ...
                         <span>
                           ...
                           <c:if test="${requestScope.BanksList != null}">
                            ...
                            <p class="margin-top-20"><a href="#"
                                    ...
                                    <span class="delete">
                                        <a class="icon-trash"
                                           href="CompareAg?IDToRemove=${compare.idCheck}&&Currancy=<%= request.getParameter("Currancy")%>&&clientCode=${compare.SID}"></a>
                                ...
                                <div class="def-input int-dashed">
                                    ...
                                    <c:choose>
                                        <c:when test="${currancy == 'AMD'}">
                                            <form action="CompareAg" method="post"
                ...
                <form action="CompareAg" name="compareNewAmount" type="get">
                    <div class="flex align-items-center">
                        <div class="flex-item">
                        ...
                        <c:forEach var="compare" items="${requestScope.consumerCreditsCompareList}"
                            ...
                            <%-- &lt;%&ndash;<sql:setDataSource var="db"
                             ...
                             <sql:setDataSource var="db"
                                                ...
                                                user="oferta_root" password="mnbvcxz00A!"/>
                         <sql:query dataSource="${db}" var="comment">
                         SELECT * FROM agriculturalcreditcontroller &lt;%&ndash;WHERE bankId=BankId&ndash;%&gt; ;
                         </sql:query>
                        ...
                        <div class="flex-item">
                            <div class="def-select-box select-dashed">
                                ...
                                <c:choose>
                                    ...
                                    <c:when test='<%=convertToMonths > 10 || convertToMonths == 0%>'>
                                        <select name="months${TheCount.count}" id="select_month"
                                                onchange="document.compareNewAmount.submit();">
                                            <option value="1" >1 Տարի</option>
                                            <option value="2" >2 Տարի</option>
                    ...
                    <c:forEach var="compare" items="${requestScope.consumerCreditsCompareList}">
                        ...
                        <div class="flex-item">
                            ...
                            <c:forEach items="${requestScope.ConsumerMainList}" var="perceentage">
                                ...
                                <c:set var="percentage" scope="request" value="${perceentage.ACFactual}"/>
                                <c:choose>
            ...
            <div class="flex align-items-center">
                ...
                <c:if test="${requestScope.consumerCreditsCompareList != null}">
                    <c:forEach var="compare" items="${requestScope.consumerCreditsCompareList}" varStatus="TheCount">
                        ...
                        <div class="flex-item">
                            <h3 class="timer count-title count-number bold blue"
                                data-to="<%=calculatePercentage(Amount2, percent2, month2) * (month2 * 12) + service2 %>"
                                data-speed="1739"></h3>
