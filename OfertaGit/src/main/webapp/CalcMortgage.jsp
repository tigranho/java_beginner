                                ...
                                <c:if test="${requestScope.valueTwo !=null}">
                                    <c:forEach items="${requestScope.dropDownsListWithCurrancy}"
                                        ...
                                        <input type="text" name="value_two" min="<%=MinAmount(discountAmount,10)%>"
                                               max="<%=maximumAmount(discountAmount,80)%>" step="${dropDownList2.steps}"
                            ...
                            <div class="def-input">
                                ...
                                <c:choose>
                                    <c:when test="${curancy == 'AMD'}">
                                        <input type="text" name="percentageSecond" value="<%=percentageForDiscount%> %"
                    ...
                    <c:forEach items="${requestScope.depositeAseList}" var="SpecialDeposit">
                        <div class="table">
                            <div class="table-row">
                                ...
                                <div class="table-cell">
                                    <c:out value="${SpecialDeposit.productName}"/><br>
                                    <p class="font-24 bold">${SpecialDeposit.MFatual}%</p>
                                    <small>№ ${SpecialDeposit.productCode}</small>
                                </div>
                                <c:set value="${dropDownList2.minAmount}" var="Amounting"
                                       scope="request"/>
                                <div class="table-cell">
                                    <c:set var="percentageMainMain" value="${SpecialDeposit.MFatual}" scope="request"/>

                                    <%!
                                        static long secoundAmount;
                                    %>
                                    ...
                                    <%
                                        ...
                                        double percentMain = Double.parseDouble(String.valueOf(request.getAttribute("percentageMainMain")));
                                        long AmountMain = Long.parseLong((String) request.getAttribute("minAmount"));//100000
                                        if (request.getParameter("months") != null) {
                                            monthMain = Long.parseLong(request.getParameter("months"));//1
                                        } else {
                                            monthMain = Long.parseLong(String.valueOf(request.getAttribute("months")));//1
                                        }
                                        if (monthMain == 0) {
                                            monthMain = 1;
                                        }
                                    ...
                                    %>
                                    <c:set var="SecondAmount"
                                           value='<%=discountingAmount2(AmountMain,percentageForDiscount2)%>'
                                           scope="request"/>
                                    <%
                                        secoundAmount = 0;

                                        if (request.getAttribute("RangeTwo") != null) {
                                            secoundAmount = Long.parseLong(String.valueOf(request.getAttribute("RangeTwo")));
                                        }
                                    %>
                                    <%!
                                        long entamenVjarumHavasar(long Amount, double percentage, long Months) {
                                            percentage /= 100.0;
                                            double monthlyRate = percentage / 12.0;
                                            long termInMonths = Months * 12;
                                    ...
                                    <c:choose>
                                        <c:when test="${currancy == 'AMD'}">
                                            <h2 class="timer count-title count-number font-28 bold"
                                                data-to="<%=entamenVjarumHavasar(AmountMain-secoundAmount, percentMain, monthMain) %>"
                                                data-speed="1739"></h2>
                                ...
                                <div class="table-cell">
                                    ...
                                    <c:forEach var="CommentsDao" items="${comment.rows}"
                                        ...
                                        <c:set value="${SpecialDeposit.productCode}" var="productCode"/>
                                ...
                                <div class="table-cell text-center">
                                    ...
                                    <a href="CreditSend?ProductCode=${SpecialDeposit.productCode}&&MaxAmount=<%=request.getParameter("MaxAmount")%>&&percentageSecond=<%=request.getParameter("percentageSecond")%>&&months=<%=request.getAttribute("months")%>&&PageToGo=Mortgage&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&range_two=<%=discountingAmount(discountAmount,percentageForDiscount)%>&&options=<%=request.getParameter("options")%>&&Amount=<%=request.getAttribute("range")%>"
                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ ավելին</a>
                                    <p>
                                        <a href="CalculateMort?id=${SpecialDeposit.productCode}&&percentageSecond=<%=request.getAttribute("percentageSecond")%>&&range_two=<%=request.getAttribute("RangeTwo")%>&&options=<%=request.getParameter("options")%>&&months=<%=request.getParameter("months")%>&&MaxAmount=<%=request.getParameter("MaxAmount")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getParameter("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                    ...
                                    <p>
                                        ...
                                        <a href="CreditSend?ProductCode=${SpecialDeposit.productCode}&&options=<%=request.getParameter("options")%>&&MaxAmount=<%=request.getParameter("MaxAmount")%>&&percentageSecond=<%=request.getParameter("percentageSecond")%>&&months=<%=request.getAttribute("months")%>&&PageToGo=Mortgage&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&range_two=<%=discountingAmount(discountAmount,percentageForDiscount)%>&&options=<%=request.getParameter("options")%>&&Amount=<%=request.getAttribute("range")%>"
                ...
                <div class="table hide-for-mb">
                    <div class="table-row head sorting">
                        ...
                        <div class="table-cell">
                            ...
                            <form action="CalculateMort" method="post" name="SortingPercentageDesc">
                                ...
                                <input name="percentageSecond" value="<%=request.getParameter("percentageSecond")%>"
                                       type="hidden">
                            ...
                            <form action="CalculateMort" method="post" name="SortingPercentageAsec">
                        ...
                        <div class="table-cell">
                            <%-- <c:set value="${requestScope.arrow2}" var="arrow2"/>
                             <c:choose>
                                 ...
                                 <c:when test="${arrow2 == 0}">
                                     <i class="icon-polygon-down active"></i>
                                     <i class="icon-polygon-up " onclick="document.SortingTimeAsecAmount.submit();"></i>
                                 </c:when>
                             </c:choose>--%>

                            <span>Գումար</span>
                            <form action="CalculateMort" method="post" name="SortingTimeDescAmount">
                            ...
                            <form action="CalculateMort" method="post" name="SortingTimeAsecAmount">
                                <input name="MaxAmount" value="<%=request.getParameter("MaxAmount")%>" type="hidden">
                                <input name="City" value="<%=request.getParameter("City")%>" type="hidden">
                                <input name="Currancy" value="<%=request.getParameter("Currancy")%>" type="hidden">
                                <input name="PageToGo" value="<%=request.getAttribute("PageToGo")%>" type="hidden">
                    ...
                    <div class="table-row ">
                        <div class="table-cell item-img">
                            ...
                            <c:if test="${requestScope.depositAllInRage != null}">
                                <c:forEach var="firstDepo" items="${requestScope.depositAllInRage}"
                                           varStatus="loop">
                                    <c:set var="percentageMain" value="${firstDepo.MFatual}" scope="request"/>
                                                ...
                                                <div class="table">
                                                    <div class="table-row">
                                                        ...
                                                        <div class="table-cell item-img">
                                                            ...
                                                            <%-- <div class="table-cell">
                                                                 <p><a href=""
                                                                       class="blue-dark-link">${firstDepo.productName}</a>
                                                                 </p>
                                                             </div>--%>
                                                        <div class="table-cell">
                                                            <c:out value="${firstDepo.productName}"/><br>
                                                                <%-- <p>Տարեկան ավանդական տոկոսը</p>--%>
                                                            <p class="font-24 bold">${firstDepo.MFatual}%</p>
                                                            <small>№ ${firstDepo.productCode}</small>
                                                        </div>
                                                            <%--<div class="table-cell">
                                                               &lt;%&ndash; <p>Ավանդի ժամկետը</p>&ndash;%&gt;
                                                                <p class="font-24 bold">${firstDepo.MMinPeriodMonth/30}
                                                                    Ամիս</p>
                                                            </div>--%>
                                                            <%-- <div class="table-cell">
                                                        ...
                                                        <div class="table-cell">
                                                                <%--  <p>Ձեր եկամուտը</p>--%>
                                                            <%!
                                                                long entamenVjarumHavasar2(long Amount, double percentage, long Months) {
                                                                    if (Months == 0) {
                                                                        Months = 1;
                                                                    }
                                                                    percentage /= 100.0;
                                                            ...
                                                            <%
                                                              ...
                                                              /*  secoundAmount = Long.parseLong(String.valueOf(request.getAttribute("SecondAmount")));
                                                                secoundAmount = Long.parseLong(String.valueOf(request.getAttribute("SecondAmount")));*/
                                                                double percent = Double.parseDouble(String.valueOf(request.getAttribute("percentageMain")));
                                                                long Amount = Long.parseLong((String) request.getAttribute("minAmount"));//100000
                                                                if (request.getParameter("months") != null && !request.getParameter("months").equals("0")) {
                                                                    month = Long.parseLong(request.getParameter("months"));//1
                                                                } else {
                                                                    month = Long.parseLong(String.valueOf(request.getAttribute("months")));//1
                                                                }
                                                            %>
                                                            <c:set value="${requestScope.PageCurrancy}" var="curancy"/>
                                                            <c:choose>
                                                                <c:when test="${curancy == 'AMD'}">
                                                                    <h2 class="timer count-title count-number font-28 bold"
                                                                        data-to="<%=entamenVjarumHavasar2(Amount-secoundAmount, percent, month) %>"
                                                                        data-speed="1739"></h2>
                                                                    <%-- <p class="font-24 bold"><fmt:formatNumber
                                                                             type="number" maxFractionDigits="3"
                                                                             value='<%=calculatePercentage(Amount, percent, month) %>'/></p>--%>
                                                                </c:when>
                                                                <c:when test="${curancy == 'USD'}">
                                                                    <h2 class="timer count-title count-number font-28 bold"
                                                                        data-to="<%=entamenVjarumHavasar2(Amount-secoundAmount, percent, month) %>"
                                                        ...
                                                        <div class="table-cell text-center last">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${gotoPage == 1 || sendRequest== 1 && lastLogic == 0}">
                                                                    <a href="CreditSend?ProductCode=${firstDepo.productCode}&&options=<%=request.getParameter("options")%>&&percentageSecond=<%=request.getParameter("percentageSecond")%>&&months=<%=request.getAttribute("months")%>&&PageToGo=Mortgage&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&MaxAmount=<%=request.getParameter("MaxAmount")%>&&range_two=<%=discountingAmount(discountAmount,percentageForDiscount)%>&&options=<%=request.getParameter("options")%>&&Amount=<%=request.getAttribute("range")%>"
                                                                       class="def-button btn-green with-shadow  margin-bottom-15">Իմանալ
                                                                        ավելին</a>
                                                                    <a href="CalculateMort?id=${firstDepo.productCode}&&percentageSecond=<%=request.getAttribute("percentageSecond")%>&&range_two=<%=request.getAttribute("RangeTwo")%>&&options=<%=request.getParameter("options")%>&&months=<%=request.getParameter("months")%>&&MaxAmount=<%=request.getParameter("MaxAmount")%>&&City=<%=request.getParameter("City")%>&&Currancy=<%=request.getParameter("Currancy")%>&&PageToGo=<%=request.getParameter("PageToGo")%>&&Amount=<%=request.getAttribute("range")%>&&PageName=Deposit"
                                                                       class="blue-link font-12 linkScrollDown">Համեմատել</a>
                                    ...
                                    <div class="simple-carousel margin-top-30">
                                        <div class="owl-carousel owl-theme" id="simpleCarousel">
                                            <c:if test="${requestScope.depositListOffer!=null}">
                                                <c:forEach items="${requestScope.depositListOffer}"
                                                           var="SpecialDeposit">
                                            ...
                                            <c:if test="${requestScope.MortgageListOffer!=null}">
                                                <c:forEach items="${requestScope.MortgageListOffer}"
                                                    ...
                                                    <div class="special-offer-item">
                                                        ...
                                                        <div>
                                                            <c:set value="${SpecialMortgage.MMinPeriodMonth}"
                                                                   var="monthS" scope="request"/>
                                                            <%
                            ...
                            <div class="tab-content" id="consumer-loan">
                                <div class="top">
                                    ...
                                    <a href="ConsumerClient?Currancy=${requestScope.PageCurrancy}&&Amount=<%=conMinAmount%>&&MaxAmounr=<%=contgageMaxAmount%>"
                                       class="green-link width-icon ellipsis width-percent-70 block"> <i
