...
<html>
   <meta property="og:title" content="Oferta.am">
    ...
    <link rel="stylesheet" href="${root}/resources/demos/style.css">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="${root}/images/favicon.png" rel="shortcut icon">

    <link rel="stylesheet" href="${root}/fonts/icomoon/style.css" type="text/css">
    <link rel="stylesheet" href="${root}/css/global.css" type="text/css">
    <link rel="stylesheet" href="${root}/libs/owl/owl.carousel.min.css"/>
    <link rel="stylesheet" href="${root}/css/style.css">
    <link rel="stylesheet" href="${root}/css/materialize.css">

    <script src="${root}/js/jquery-1.9.1.min.js"></script>
    <script src="${root}/js/Compare.js"></script>
    <script>
        (function ($) {
            ...
            <div class="inner-container large">
               ...
               <span class="logo">
                   <a href="App?PageLanguage=${requestScope.Pagelanguage}"> <img
                           src="${root}/images/oferta.png" alt=""/></a>
               </span>
        ...
        <div class="navigation" id="mbNav">
            <div class="inner-container large">
                <div class="flex space-between align-items-center inner-content flex-wrap">
                    <jsp:include page="${root}/include/Search.jsp"/>
    ...
    <div class="bg-white-dark padding-bottom-60 bank-item-page">
        <div class="inner-container">
            ...
            <div class="row row-flex flex flex-wrap credit-info">
                ...
                <div class="col-4 flex align-items-center item">
                    <span>Կանխավճար</span><span>${details.MMinDownPayment}%</span>
                </div>
                <div class="col-4 flex align-items-center item">
                    <span>Փաստացի տոկոսադրույք</span><span>${details.MMinLoan}% - ${details.MMaxLoan}%</span>
                </div>
                <div class="col-4 flex align-items-center item">

                    <span>Վարկի գումարը</span><span><fmt:formatNumber type="number" maxFractionDigits="3"
                                                                      value="${details.MMinAmount}"/>  -  <fmt:formatNumber
                        type="number" maxFractionDigits="3" value="${details.MMaxAmount}"/></span>
                </div>
                <div class="col-4 flex align-items-center item">
                    <span>Սպասարկման վճար</span><span><fmt:formatNumber type="number" maxFractionDigits="3"
                                                                        value="${details.MMinServiceFee}"/> -
                <fmt:formatNumber type="number" maxFractionDigits="3"
                                  value="${details.MMaxServiceFee}"/></span>
                </div>
                <div class="col-4 flex align-items-center item">
                    <span>Վարկառուի տարիքը</span><span>${details.minAge}-${details.maxAge}</span>
                </div>
                <div class="col-4 flex align-items-center item">
                    <span>Վարկի ժամկետ</span><span>${details.MMinPeriodMonth} Տարի - ${details.MMaxPeriodMonth} Տարի</span>
                </div>
                <div class="col-4 flex align-items-center item">
                                ...
                                <div class="range-group">
                                    <div class="def-range int-outline">
                                        <c:if test="${requestScope.valueTwo!=null}">
                                            <c:forEach items="${requestScope.dropDownsListWithCurrancy}"
                                                       var="dropDownList2" varStatus="loop">
                                                <c:set value="${dropDownList2.minAmount}" var="AmountDiscounted"
                                                       scope="request"/>
                                                <c:set value="${dropDownList2.minAmount}" var="AmountDiscounted2"
                                                       scope="request"/>
                                ...
                                <div class="def-select-box st-outline">
                                    <c:set var="monthsSection" value='<%=request.getAttribute("months")%>'/>
                                            <select name="months" id="select_month"
                                                ...
                                                <option value="1" <c:if test="${monthsSection == '1'}">selected</c:if>>1 Տարի</option>
                                                <option value="2" <c:if test="${monthsSection == '2'}">selected</c:if>>2 Տարի</option>
                                                <option value="3" <c:if test="${monthsSection == '3'}">selected</c:if>>3 Տարի</option>
                                                <option value="4" <c:if test="${monthsSection == '4'}">selected</c:if>>4 Տարի</option>
                                                <option value="5" <c:if test="${monthsSection == '5'}">selected</c:if>>5 Տարի</option>
                                                <option value="6" <c:if test="${monthsSection == '6'}">selected</c:if>>6 Տարի</option>
                                                <option value="7" <c:if test="${monthsSection == '7'}">selected</c:if>>7 Տարի</option>
                                                <option value="8" <c:if test="${monthsSection == '8'}">selected</c:if>>8 Տարի</option>
                                                <option value="9" <c:if test="${monthsSection == '9'}">selected</c:if>>9 Տարի</option>
                                                <option value="10" <c:if test="${monthsSection == '10'}">selected</c:if>>10 Տարի</option>
                                                <option value="12" <c:if test="${monthsSection == '12'}">selected</c:if>>12 Տարի</option>
                                                <option value="15" <c:if test="${monthsSection == '15'}">selected</c:if>>15 Տարի</option>
                                                <option value="20" <c:if test="${monthsSection == '20'}">selected</c:if>>20 Տարի</option>
                                                <option value="25" <c:if test="${monthsSection == '25'}">selected</c:if>>25 Տարի</option>
                                                <option value="30" <c:if test="${monthsSection == '30'}">selected</c:if>>30 Տարի</option>
                                            </select>
                                        ...
                                        <div>
                                            ...
                                            <%
                                                ...
                                                if (request.getParameter("range_two") != null) {
                                                    ...
                                                    rangeSecond = (long) (AmountSecond * 0.10);
                                                }
                                            ...
                                            <h2 class="timer count-title count-number font-28 bold"
                                                data-to="<%=calculateMonthly(AmountSecond-rangeSecond,MonthsSet*12,percent)%>"
                                                data-speed="1739"></h2>
                            ...
                            <div class="col-8 right-side mobile-right__sides">
                                ...
                                <div class="row-md clearfix  form-row button-row">
                                    <div class="col-12">
                                        ...
                                        <input type="hidden" name="mfatualpage" value="${details.MFatual}">
                                    </div>
                                </div>
                            </div>
                        </form>
