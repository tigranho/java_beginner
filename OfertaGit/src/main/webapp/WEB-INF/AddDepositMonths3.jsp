    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="AddEurMonths" method="post">
                        <div class="header">
                            ...
                            <h2 class="card-inside-title">Ժամկետային ավանդների տարեկան տոկոսադրույքները EUR</h2>
                            <br>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <!-- /////////////////////////////////////////////////////////////////////////////////Comment Armenian -->
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="EUR1Month" class="form-control"  value="0.0" step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="EUR3Month" class="form-control"  value="0.0" step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="EUR6Month" class="form-control"  value="0.0" step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="EUR9Month" class="form-control"  value="0.0" step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="EUR12Month" class="form-control"  value="0.0" step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="EUR18Month" class="form-control"  value="0.0" step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="EUR24Month" class="form-control"  value="0.0" step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="EUR36Month" class="form-control"  value="0.0" step="0.01"/>
