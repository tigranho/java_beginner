    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="AddNewCCComment" method="post">
                        <div class="header">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <label class="form-label" required>Ավելացնել առաջին մեկնաբանությունը Հայերեն</label>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <label class="form-label" required>Ավելացնել Երկրորդ մեկնաբանությունը Հայերեն</label>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <label class="form-label" required>Ավելացնել Երրորդ մեկնաբանությունը Հայերեն</label>
                                   ...
                                   <%-- <!-- /////////////////////////////////////////////////////////////////////////////////Comment english -->
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <label class="form-label" required>Ավելացնել առաջին մեկնաբանությունը Անգլերեն</label>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <label class="form-label" required>Ավելացնել Երկրորդ մեկնաբանությունը
                                                Անգլերեն</label>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <label class="form-label" required>Ավելացնել Երրորդ մեկնաբանությունը Անգլերեն</label>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <label class="form-label" required>Ավելացնել առաջին մեկնաբանությունը Ռուսերեն</label>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <label class="form-label" required>Ավելացնել Երրորդ մեկնաբանությունը Ռուսերեն</label>
