                        ...
                        <table id="mainTable" class="table table-striped">
                            ...
                            <c:if test="${requestScope.ListMarketing != null}">
                                <c:forEach items="${requestScope.ListMarketing}" var="ListMarketing" varStatus="loop">
                                    <form action="UpdateCarLoanApperanceInData" method="post">
                                        <tr>
                                            ...
                                            <td><input type="number" name="SPNumber" class="form-control"
                                                       value="${ListMarketing.orderOfAppearance}"/></td>
                                            ...
                                            <input type="hidden" name="Id" value="${ListMarketing.CLId}"/>
                                            <td>
                                                <button type="submit"
