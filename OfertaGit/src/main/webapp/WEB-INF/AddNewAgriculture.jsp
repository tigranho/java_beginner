    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="AddNewAgricultureToData" method="post">
                        <div class="header">
                            ...
                            <h2 class="card-inside-title">Նոր Գյուղատնտեսական վարկեր տեղեկատվության ավելացում</h2>
                            <br>
                            <div class="row clearfix">
                               <%-- <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <label class="form-label" required>Վարկի անվանում Հայերեն</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="ACMinAmount" class="form-control" required/>
                                            <label class="form-label" required>Վարկի նվազագույն գումարը</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="ACMaxAmount" class="form-control" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="ACMinLoan" class="form-control" step="0.01" min="0" max="200" required/>
                                            <label class="form-label" required>Վարկի Նվազագույն %</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="ACMacLoan" class="form-control" step="0.01" min="0" max="200" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="ACPerFactual" class="form-control" step="0.01" min="0" max="200" required/>
                                            <label class="form-label" required>Փաստացի</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select class="form-control show-tick" id="ACMinPeriodMonth" name="ACMinPeriodMonth" required>
                                   ...
                                   <%-- <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="ACMinPeriodMonth" class="form-control" required/>
                                            <label class="form-label" required>Նվազագույն ժամկետը տարով</label>
                                        </div>
                                    </div>--%>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select class="form-control show-tick" id="ACMaxPeriodMonth" name="ACMaxPeriodMonth" required>
                                                <%-- <input type="text" name="MMinPeriodMonth" class="form-control" required/>--%>
                                                <option value="1">1 </option>
                                                <option value="2">2 </option>
                                                <option value="3">3 </option>
                                  ...
                                  <%--  <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="ACMaxPeriodMonth" class="form-control" required/>
                                            <label class="form-label" required>Առավելագույն ժամկետը տարով</label>
                                        </div>
                                    </div>--%>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="ACMinServiceFee" class="form-control" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="ACMaxServiceFee" class="form-control" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="ACMinAge" class="form-control" required/>
                                            <label class="form-label">Վարկի նվազագույն թույլատրված տարիքը</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="ACMaxAge" class="form-control" required/>
