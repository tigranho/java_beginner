        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <form action="AddNewArmenianBlogToDataStepOne" method="post">
                        <div class="header">
                            <h2> Ավելացնել նոր բլոգ Հայերեն </h2>
                            <small> Դուք կարող եք թարմացնել այլ լեզուները բոլոր բլոգներից</small>
                        </div>
                        <div class="col-sm-12">
                        ...
                        <div class="body">
                            <h3>Օրագիր</h3>
                            <textarea id="ckeditor" name="BlogArmenianBody">
                                 </textarea>
                        </div>
                        <div class="col-xs-3">
