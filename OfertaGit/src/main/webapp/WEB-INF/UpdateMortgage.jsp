    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="UpdateMortgageDetailsToData" method="post">
                        <div class="header">
                            ...
                            <c:if test="${requestScope.MortgageList != null}">
                                <c:forEach items="${requestScope.MortgageList}" var="mortgageList" varStatus="page">
                                    <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="content-area">
                                                    <h4> Վարկի կոդը : <c:out value="${mortgageList.productCode}"/></h4>

                                                </div>
                                                <input type="hidden" name="ProductCode" value="${mortgageList.productCode}">

                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="productName" class="form-control"
                                                           value="${mortgageList.productName}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select class="form-control show-tick" id="BankName" name="BankName">
                                                        <option name="bankName" value="${mortgageList.bankName}" selected>${mortgageList.bankName}</option>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="MMinAmount" class="form-control"
                                                           value="${mortgageList.MMinAmount}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="MMaxAmount" class="form-control"
                                                           value="${mortgageList.MMaxAmount}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="MMinLoan" class="form-control" value="${mortgageList.MMinLoan}" step="0.01" min="0" max="200"/>
                                                    <label class="form-label">Վարկի Նվազագույն %</label>
                                                </div>
                                            </div>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="MMaxLoan" class="form-control" value="${mortgageList.MMaxLoan}" step="0.01" min="0" max="200"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="MFatual" class="form-control" value="${mortgageList.MFatual}" step="0.01" min="0" max="200"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="MMinxDownPayment" class="form-control" value="${mortgageList.MMinDownPayment}"/>
                                                    <label class="form-label">Նվազագույն կանխավճար</label>
                                                </div>
                                            </div>

                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="MMaxDownPayment" class="form-control" value="${mortgageList.MMaxDownPayment}"/>
                                                    <label class="form-label">Առավելագույն կանխավճար</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    >
                                                        <option name="Currancy" value="${mortgageList.currancy}" selected>${mortgageList.currancy}</option>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select class="form-control show-tick" id="cardTyp3e" name="MRepayment"
                                                    >
                                                        <option name="MRepayment" value="${mortgageList.MRepayment}" selected>${mortgageList.MRepayment}</option>
                                                        <c:if test="${requestScope.RePaymentOptionsList != null}">
                                                            <c:forEach items="${requestScope.RePaymentOptionsList}" var="OptionList">
                                                                <option name="MRepayment"
                                                                        value="${OptionList.rePrepaimentOptionAm}">${OptionList.rePrepaimentOptionAm}</option>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="MMinPeriodMonth" class="form-control" value="${mortgageList.MMinPeriodMonth}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="MMaxPeriodMonth" class="form-control" value="${mortgageList.MMaxPeriodMonth}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="MMinServiceFee" class="form-control" value="${mortgageList.MMinServiceFee}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="MMaxServiceFee" class="form-control" value="${mortgageList.MMaxServiceFee}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="minAge" class="form-control" value="${mortgageList.minAge}"/>
                                                    <label class="form-label">Վարկի նվազագույն թույլատրված տարիքը</label>
                                                </div>
                                            </div>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="maxAge" class="form-control" value="${mortgageList.maxAge}"/>
                                                ...
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input type="text" name="BankLink" class="form-control"
                                                               value="${mortgageList.bankLink}"/>
                                                        <label class="form-label">Բանկի հղում</label>
                                                    </div>
                                                </div>

                                            <div class="col-xs-3">
                                                <input type="hidden" name="MId" value="${mortgageList.MId}"/>
