    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                <form class="form-inline" action="SearchMortgag" method="get">
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <c:if test="${requestScope.MortgageList != null}">
                <c:forEach items="${requestScope.MortgageList}" var="MortgageList"
                           varStatus="loop">
                                ...
                                <div class="card profile-card">
                                    ...
                                    <div class="profile-body">
                                        ...
                                        <div class="content-area">
                                            <h3>Վարկի անվանումը : <c:out value="${MortgageList.productName}"/></h3>

                                        </div>
                                        <div class="content-area">
                                            <h4>
                                                Վարկի կոդը : <c:out value="${MortgageList.productCode}"/></h4>
                                        </div>
                                    </div>
                                    <div class="profile-footer">
                                        <ul>
                                            <li>
                                                <span>Բանկ</span>
                                                <span><c:out
                                                        value="${MortgageList.bankName}"/></span>
                                            </li>

                                            <li>
                                                <span>Արժույթ</span>
                                                <span><c:out
                                                        value="${MortgageList.currancy}"/></span>
                                            </li>
                                            <li>
                                                <span>Նվազագույն գումար</span>
                                                <span><c:out
                                                        value="${MortgageList.MMinAmount}"/></span>
                                            </li>

                                            <li>
                                                <span>Առավելագույն գումար</span>
                                                <span><c:out
                                                        value="${MortgageList.MMaxAmount}"/></span>
                                            </li>

                                            <li>
                                                <span>Նվազագույն վարկ</span>
                                                <span><c:out
                                                        value="${MortgageList.MMinLoan}"/></span>
                                            </li>

                                            <li>
                                                <span>Առավելագույն վարկ</span>
                                                <span><c:out
                                                        value="${MortgageList.MMaxLoan}"/></span>
                                            </li>

                                            <li>
                                                <span>Փաստացի</span>
                                                <span><c:out
                                                        value="${MortgageList.MFatual}"/> </span>
                                            </li>


                                            <li>
                                                <span>Նվազագույն վճարում</span>
                                                <span><c:out
                                                        value="${MortgageList.MMinDownPayment}"/> </span>
                                            </li>


                                            <li>
                                                <span>Առավելագույն վճարում</span>
                                                <span><c:out
                                                        value="${MortgageList.MMaxDownPayment}"/> </span>
                                            </li>

                                            <li>
                                                <span>Նվազագույն ծառայության վճար</span>
                                                <span><c:out
                                                        value="${MortgageList.MMinServiceFee}"/> </span>
                                            </li>

                                            <li>
                                                <span>Առավելագույն ծառայության վճար</span>
                                                <span><c:out
                                                        value="${MortgageList.MMaxServiceFee}"/> </span>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <span><c:out
                                                        value="${MortgageList.MMinPeriodMonth}"/> Ամիս </span>
                                            </li>

                                            <li>
                                                <span>Առավելագույն ժամանակաշրջան</span>
                                                <span><c:out
                                                        value="${MortgageList.MMaxPeriodMonth}"/> Ամիս</span>
                                            </li>

                                            <li>
                                                <span>Նվազագույն տարիքը</span>
                                                <span><c:out
                                                        value="${MortgageList.minAge}"/>  </span>
                                            </li>

                                            <li>
                                                <span>Առավելագույն տարիքը</span>
                                                <span><c:out
                                                        value="${MortgageList.maxAge}"/> </span>
                                            </li>

                                             <li>
                                                <span>Մարման տաչբերակ</span>
                                                  <span><c:out
                                                        value="${MortgageList.MRepayment}"/> </span>
                                                <input type="hidden" name="MRepayment" value="${MortgageList.MRepayment}"/>
                                                <input type="hidden" name="MRepaymentՕptionid" value="${MortgageList.MRepaymentId}">
                                            </li>
                                       ...
                                       <%-- <form action="UpdateProductName" method="post">
                                        ...
                                        <form action="DeleteMortgage" method="post">
