    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="AddNewCarLoanToData" method="post">
                        <div class="header">
                            ...
                            <h2 class="card-inside-title">Նոր աֆտո վարկեր տեղեկատվության ավելացում</h2>
                            <br>
                            <div class="row clearfix">
                                <%--<div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="CLMinAmount" class="form-control" required/>
                                            <label class="form-label" required>Վարկի նվազագույն գումարը</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="CLMaxAmount" class="form-control" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="CLMinLoan" class="form-control"  step="0.01" min="0" max="200" required/>
                                            <label class="form-label" required>Վարկի Նվազագույն %</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="CLMacLoan" class="form-control"  step="0.01" min="0" max="200" required/>
                                            <label class="form-label" required>Վարկի առավելագույն %</label>
                                        </div>
                                    </div>

                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="CLPerFactual" class="form-control"  step="0.01" min="0" max="200" required/>
                                            <label class="form-label" required>Փաստացի</label>
                                        </div>
                                    </div>

                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="CLMinDownPayment" class="form-control" required/>
                                            <label class="form-label" required>նվազագույն կանխավճար</label>
                                        </div>
                                    </div>

                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="CLMaxDownPayment" class="form-control" required/>
                                            <label class="form-label" required>Առավելագույն կանխավճար</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="CLMinPeriodMonths" class="form-control" required/>
                                            <label class="form-label" required>նվազագույն ժամկետը ամիսով</label>
                                        </div>
                                    </div>

                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="CLMaxPeriodMonth" class="form-control" required/>
                                            <label class="form-label" required>Առավելագույն ժամկետը ամիսով</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="CLMinServiceFee" class="form-control" required/>
                                            <label class="form-label" required>Վարկի նվազագույն սպասարկման </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="ClMaxServiceFee" class="form-control" required/>
                                            <label class="form-label" required>Վարկի առավելագույն սպասարկման</label>
                                        </div>
                                    </div>

                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="ClMinAge" class="form-control" required/>
                                            <label class="form-label" required>Վարկի նվազագույն թույլատրված</label>
                                        </div>
                                    </div>

                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="ClMaxAge" class="form-control" required/>
                                            <label class="form-label" required>Վարկի առավելագույն թույլատրված </label>
                                        </div>
                                    </div>
...
<!-- Demo Js -->
<script src="<%=request.getContextPath()%>/admin/js/demo.js"></script>pt>
</body>
