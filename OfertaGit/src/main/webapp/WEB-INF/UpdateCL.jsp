    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="UpdateCLDetailsToData" method="post">
                        <div class="header">
                            ...
                            <c:if test="${requestScope.carLoansList != null}">
                                <c:forEach items="${requestScope.carLoansList}" var="ClFullList" varStatus="page">
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="content-area">
                                                <h4> Վարկի կոդը : <c:out value="${ClFullList.productCode}"/></h4>

                                            </div>
                                            <input type="hidden" name="ProductCode" value="${ClFullList.productCode}">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="ProductName" class="form-control"
                                                           value="${ClFullList.productName}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select class="form-control show-tick" id="BankName"
                                                            name="BankName">
                                                        <option name="bankName" value="${ClFullList.bankName}"
                                                                selected>${ClFullList.bankName}</option>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CLMinAmount" class="form-control"
                                                           value="${ClFullList.CLMinAmount}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CLMaxAmount" class="form-control"
                                                           value="${ClFullList.CLMaxAmount}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CLMinLoan" class="form-control"
                                                           value="${ClFullList.CLMinLoan}" step="0.01" min="0"
                                                           max="200"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CLMacLoan" class="form-control"
                                                           value="${ClFullList.CLMaxLoan}" step="0.01" min="0"
                                                           max="200"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CLPerFactual" class="form-control"
                                                           value="${ClFullList.CLFatual}" step="0.01" min="0"
                                                           max="200"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CLMinDownPayment" class="form-control"
                                                           value="${ClFullList.CLMinDownPayment}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CLMaxDownPayment" class="form-control"
                                                           value="${ClFullList.CLMaxDownPayment}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    >
                                                        <option name="currancy" value="${ClFullList.currancy}"
                                                                selected>${ClFullList.currancy}</option>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CLMinPeriodMonths" class="form-control"
                                                           value="${ClFullList.CLMinPeriodMonths}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CLMaxPeriodMonth" class="form-control"
                                                           value="${ClFullList.CLMaxPeriodMonths}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CLMinServiceFee" class="form-control"
                                                           value="${ClFullList.CLMinServiceFee}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="ClMaxServiceFee" class="form-control"
                                                           value="${ClFullList.CLMaxServiceFee}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="ClMinAge" class="form-control"
                                                           value="${ClFullList.minAge}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="ClMaxAge" class="form-control"
                                                           value="${ClFullList.maxAge}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="BankLink" class="form-control"
                                                           value="${ClFullList.bankLink}"/>
                                                    <label class="form-label">Բանկի հղում</label>
                                                </div>
                                            </div>

                                            <div class="col-xs-3">
                                                <input type="hidden" name="CLId" value="${ClFullList.CLId}"/>
