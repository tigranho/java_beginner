    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="AddNewMortgageToData" method="post">
                        <div class="header">
                            ...
                            <h2 class="card-inside-title">Նոր Հիպոդեք վարկեր տեղեկատվության ավելացում</h2>
                            <br>
                            <div class="row clearfix">
                                <%--<div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="MMinAmount" class="form-control" required/>
                                            <label class="form-label" required>Վարկի նվազագույն գումարը</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="MMaxAmount" class="form-control" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="MMinLoan" class="form-control" step="0.01" min="0" max="200" required/>
                                            <label class="form-label" required>Վարկի Նվազագույն %</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="MMaxLoan" class="form-control" step="0.01" min="0" max="200" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="MFatual" class="form-control" step="0.01" min="0" max="200" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="MMinDownPayment" class="form-control" required/>
                                            <label class="form-label" required>Նվազագույն Down Payment</label>
                                        </div>
                                    </div>

                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="MMaxDownPayment" class="form-control" required/>
                                            <label class="form-label" required>Առավելագույն Down Payment</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select class="form-control show-tick" id="rePaymentOptionsList" name="MRepayment" required>
                                                <c:if test="${requestScope.rePaymentOptionsList != null}">
                                                    <c:forEach items="${requestScope.rePaymentOptionsList}"
                                                               var="rePaymentOptionsListList">
                                                        <option value="${rePaymentOptionsListList.rePrepaimentOptionAm}">${rePaymentOptionsListList.rePrepaimentOptionAm}</option>
                                                    </c:forEach>
                                                </c:if>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select class="form-control show-tick" id="MMinPeriodMonth" name="MMinPeriodMonth" required>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select class="form-control show-tick" id="MMaxPeriodMonth" name="MMaxPeriodMonth" required>
                                           <%-- <input type="text" name="MMaxPeriodMonth" class="form-control" required/>--%>
                                               <option value="1">1 </option>
                                               <option value="2">2 </option>
                                               <option value="3">3 </option>
                                               <option value="4">4 </option>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="MMinServiceFee" class="form-control" required/>
                                            <label class="form-label" required>Վարկի նվազագույն սպասարկման վճարը</label>
                                        </div>
                                    </div>

                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="MMaxServiceFee" class="form-control" required/>
                                            <label class="form-label" required>Վարկի առավելագույն սպասարկման վճար</label>
                                        </div>
                                    </div>
