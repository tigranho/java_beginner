    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="UpdateProductNameInData" method="post">
                        <div class="header">
                            ...
                            <h2 class="card-inside-title">Թարմացնել Անվանումը</h2>
                            <br>
                            <c:if test="${requestScope.productNameList !=null}">
                            <c:forEach items="${requestScope.productNameList}" var="ProductNamesList">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="productName" class="form-control" value="${ProductNamesList.productNameAm}"/>
                                            <label class="form-label">Անվանումը Հայերեն</label>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="prodeuctNameEng" class="form-control" value="${ProductNamesList.prodeuctNameEn}"/>
                                            <label class="form-label">Անվանումը Անգլերեն</label>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="productNameRus" class="form-control" value="${ProductNamesList.productNameRu}"/>
                                            <label class="form-label">Անվանումը Ռեւսերեն</label>
                                    ...
                                    <div class="col-xs-3">
                                        <button class=" btn bg-orange btn-block btn-lg waves-effect" type="submit">Թարմացնել
                                        </button>
                                        <input type="hidden" name="productCode" value="${ProductNamesList.productCode}">
                                    </div>
                                </div>
                            </div>
                            </c:forEach>
