            ...
            <div class="body">
                <div>
                    ...
                    <div class="tab-content">
                        ...
                        <c:forEach items="${requestScope.usefulArticlesList}" var="BlogList">
                        <div role="tabpanel" class="tab-pane fade in active" id="home">
                            <div class="panel panel-default panel-post">
                                <div class="panel-body">
                                    <div class="post">
                                        <div class="post-heading">
                                            <h2> ${BlogList.UATitleAm}</h2>
                                        </div>
                                        <div class="post-content ">
                                            <img src="${BlogList.UAImageLink}"
                                ...
                                <div class="post-heading">
                                    <ul>
                                            ${BlogList.UAMainTextAm}
                                    </ul>
                                </div>
                                <form action="UpdateBlogArmenian" method="get">
                                    <button class="btn bg-blue btn-lg waves-effect btn-block">
                                        Թարմացնել Բլոքի տվյալները
                                    </button>
                                    <input type="hidden" name="UAId" value="${BlogList.UAId}">
                                </form>
                                <form action="DeleteBlogArmenian" method="post">
                                    <button class="btn bg-orange btn-lg waves-effect btn-block">
                                        Ջնջել բլոգը
                                    </button>
                                    <input type="hidden" name="UAId" value="${BlogList.UAId}">
                                </form>

                                <form action="UpdateBlogImage" method="get">
                                    <button class="btn bg-green btn-lg waves-effect btn-block">
                                        Թարմացնել Բլոքի նկարը
                                    </button>
                                    <input type="hidden" name="UAId" value="${BlogList.UAId}">
                                </form>
                            </div>
