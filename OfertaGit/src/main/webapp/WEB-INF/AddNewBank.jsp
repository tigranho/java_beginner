    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="AddNewBankFirstStep" method="post">
                    <div class="header">
                        <div class="alert-info " >
                           ...
                           <h2 class="card-inside-title">Նոր բանկային տեղեկատվության ավելացում</h2>
                        <br>
                        <script>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" name="bankCode" class="form-control" onchange="handleChange(this);" required>
                                        <label class="form-label" required>Բանկի քոդը ( 1 -10000 ) Սահմանորում</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <label class="form-label" required>Բանկի անվանումը</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <label class="form-label" required>Բանկի հասցեն</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="bankPhoneNumber" class="form-control" required >
                                        <label class="form-label" required>Բանկի հեռախոսահամարը</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="bankFaxNumber" class="form-control" required/>
                                        <label class="form-label" required>Բանկի ֆաքսի համարը</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="bankHQ" class="form-control" required />
                                        <label class="form-label" required>Բանկի գլխամասային գրասենյակ</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" name="bankBranches" class="form-control" required />
                                        <label class="form-label" required>Բանկի մասնաճյուղերի քանակը</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    ...
                                    <div class="form-line">
                                        ...
                                        <input type="number" name="bankAtmQuantity" class="form-control" required />
                                        <label class="form-label" required>Բանկի բանկոմատների քանակը</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="bankSwiftCode" class="form-control" required />
                                        <label class="form-label" required>Բանկի Swift Կոդ</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="bankWebSite" class="form-control" required />
                                        <label class="form-label" required>Բանկի կայքը</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="bankEmailAddress" class="form-control" required />
                                        <label class="form-label" required>Բանկի էլ.փոստի հասցեն</label>
                                    </div>
                                </div>
                                <div class="col-xs-3">
                                    <button class=" btn bg-orange btn-block btn-lg waves-effect" type="submit">Դեպի հաջորդ քայլ >>></button>
                                </div>
                            </div>
                        </div>
