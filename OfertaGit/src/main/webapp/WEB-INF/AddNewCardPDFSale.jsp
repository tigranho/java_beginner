        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="AddNewPDFSale?productcode=<%=request.getAttribute("productcode")%>" class="dropzone"
                              method="post"
                ...
                <div class="row clearfix">
                    <div class="col-md-3">
                        ...
                        <form action="CardResultPage" method="post">
                            <button type="submit" class="btn bg-orange btn-block btn-lg waves-effect">Ավարտել
