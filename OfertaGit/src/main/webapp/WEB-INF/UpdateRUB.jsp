    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="UpdateRUBDetailsToData" method="post">
                        <div class="header">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="RUB1Month" class="form-control"
                                                           value="${DepositFullList.rubMonth1}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="RUB3Month" class="form-control"
                                                           value="${DepositFullList.rubMonth3}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="RUB6Month" class="form-control"
                                                           value="${DepositFullList.rubMonth6}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="RUB9Month" class="form-control"
                                                           value="${DepositFullList.rubMonth9}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="RUB12Month" class="form-control"
                                                           value="${DepositFullList.rubMonth12}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="RUB18Month" class="form-control"
                                                           value="${DepositFullList.rubMonth18}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="RUB24Month" class="form-control"
                                                           value="${DepositFullList.rubMonth24}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="RUB36Month" class="form-control"
                                                           value="${DepositFullList.rubMonth36}" step="0.01"/>
