    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="UpdateEURDetailsToData" method="post">
                        <div class="header">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="EUR1Month" class="form-control"
                                                           value="${DepositFullList.eurMonth1}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="EUR3Month" class="form-control"
                                                           value="${DepositFullList.eurMonth3}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="EUR6Month" class="form-control"
                                                           value="${DepositFullList.eurMonth6}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="EUR9Month" class="form-control"
                                                           value="${DepositFullList.eurMonth9}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="EUR12Month" class="form-control"
                                                           value="${DepositFullList.eurMonth12}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="EUR18Month" class="form-control"
                                                           value="${DepositFullList.eurMonth18}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="EUR24Month" class="form-control"
                                                           value="${DepositFullList.eurMonth24}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="EUR36Month" class="form-control"
                                                           value="${DepositFullList.eurMonth36}" step="0.01"/>
                                            ...
                                            <div class="col-xs-3">
                                                <input type="hidden" name="DId" value="${DepositFullList.productCode}"/>
