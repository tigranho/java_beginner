...
<section class="content">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="AddNewBankLogo?bankId=<%=request.getAttribute("newBankId")%>" class="dropzone" method="post"
    ...
    <div class="body">
        <div class="demo-masked-input">
            <div class="row clearfix">
                <div class="col-md-3">
                    <form action="AddNewBankSecondLogo" method="post">
                    <button type="submit" class="btn bg-orange btn-block btn-lg waves-effect">Դեպի հաջորդ քայլ >>>
                    </button>
                        <input type="hidden" name="bankId" value="<%=request.getAttribute("newBankId")%>">
                    </form>
                </div>
