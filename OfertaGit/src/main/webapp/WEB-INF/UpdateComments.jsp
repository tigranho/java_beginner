    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="UpdateCommentInData" method="post">
                        <div class="header">
                            ...
                            <h2 class="card-inside-title">Թարմացնել մեկնաբանությունները</h2>
                            <br>
                            <c:if test="${requestScope.commentsList !=null}">
                                <c:forEach items="${requestScope.commentsList}" var="CommentList">
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <!-- /////////////////////////////////////////////////////////////////////////////////Comment Armenian -->
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="comment1Am" class="form-control"
                                                           placeholder="առաջին մեկնաբանությունը Հայերեն"

                                                           value="${CommentList.comment1_Am}"/>
                                                    <label class="form-label">առաջին մեկնաբանությունը Հայերեն</label>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="comment2Am" class="form-control"
                                                           placeholder="Երկրորդ մեկնաբանությունը Հայերեն"

                                                                value="${CommentList.comment2_Am}"/>
                                                    <label class="form-label">Երկրորդ մեկնաբանությունը Հայերեն</label>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="comment3Am" class="form-control"
                                                           placeholder="Երրորդ մեկնաբանությունը Հայերեն"

                                                                value="${CommentList.comment3_Am}"/>
                                                    <label class="form-label">Երրորդ մեկնաբանությունը Հայերեն</label>
