    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="AddUsdMonths" method="post">
                        <div class="header">
                            ...
                            <h2 class="card-inside-title">Ժամկետային ավանդների տարեկան տոկոսադրույքները USD</h2>
                            <br>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <!-- /////////////////////////////////////////////////////////////////////////////////Comment Armenian -->
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="USD1Month" class="form-control" value="0.0"
                                                   step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="USD3Month" class="form-control" value="0.0"
                                                   step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="USD6Month" class="form-control" value="0.0"
                                                   step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="USD9Month" class="form-control" value="0.0"
                                                   step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="USD12Month" class="form-control" value="0.0"
                                                   step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="USD18Month" class="form-control" value="0.0"
                                                   step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="USD24Month" class="form-control" value="0.0"
                                                   step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="USD36Month" class="form-control" value="0.0"
                                                   step="0.01"/>
                                    ...
                                    <div class="col-xs-3">
                                        ...
                                        <input type="hidden" name="productcode"
                                               value="<%=request.getAttribute("productcode")%>">
                                    </div>
                                </div>
                            </div>
                        </div>
