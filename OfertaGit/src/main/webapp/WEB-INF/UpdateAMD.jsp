    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="UpdateAMDDetailsToData" method="post">
                        <div class="header">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="AMD1Month" class="form-control"
                                                           value="${DepositFullList.amdMonth1}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="AMD3Month" class="form-control"
                                                           value="${DepositFullList.amdMonth3}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="AMD6Month" class="form-control"
                                                           value="${DepositFullList.amdMonth6}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="AMD9Month" class="form-control"
                                                           value="${DepositFullList.amdMonth9}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="AMD12Month" class="form-control"
                                                           value="${DepositFullList.amdMonth12}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="AMD18Month" class="form-control"
                                                           value="${DepositFullList.amdMonth18}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="AMD24Month" class="form-control"
                                                           value="${DepositFullList.amdMonth24}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="AMD36Month" class="form-control"
                                                           value="${DepositFullList.amdMonth36}" step="0.01"/>
