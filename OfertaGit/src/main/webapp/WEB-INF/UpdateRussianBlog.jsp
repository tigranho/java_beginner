                ...
                <div class="card">
                    ...
                    <c:if test="${requestScope.usefulArticlesList != null}">
                        <c:forEach items="${requestScope.usefulArticlesList}" var="Blogs">
                            <form action="UpdateRussianBlogToData" method="get">
                                <div class="header">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="BlogTitle" class="form-control" value=" ${Blogs.UATitleRu}"/>
                                ...
                                <div class="body">
                                    <h3>Օրագիր</h3>
                                    <textarea id="ckeditor" name="BlogRussianBody">
                                        ${Blogs.UAMainTextRu}
                                 </textarea>
                                </div>
                                <div class="col-xs-3">
