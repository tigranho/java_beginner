    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="AddNewConsumerCreditToData" method="post">
                        <div class="header">
                            ...
                            <h2 class="card-inside-title">Նոր սպարողական ավանդի տեղեկատվության ավելացում</h2>
                            <br>
                            <div class="row clearfix">
                               <%-- <div class="col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <label class="form-label" required>Ավանդի կոտը</label>
                                        </div>
                                    </div>
                                </div>--%>
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="CoCMinAmount" class="form-control" required/>
                                            <label class="form-label" required>Վարկի նվազագույն գումարը</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="CoCMaxAmount" class="form-control" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="CCMinLoan" class="form-control" step="0.01" min="0" max="200" required/>
                                            <label class="form-label" required>Վարկի Նվազագույն %</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="CCMaxLoan" class="form-control" step="0.01" min="0" max="200" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="CCFactual" class="form-control" step="0.01" min="0" max="200" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="CoCMinPeriodMonths" class="form-control" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="CoCMaxPeriodMonth" class="form-control" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="CoCMinServiceFee" class="form-control" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="CoCMaxServiceFee" class="form-control" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="CoCMinAge" class="form-control" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="CoCMaxAge" class="form-control" required/>
