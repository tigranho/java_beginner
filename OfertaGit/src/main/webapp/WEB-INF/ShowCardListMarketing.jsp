                    ...
                    <div class="body">
                        <table id="mainTable" class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th>Բանկը</th>
                                <th>Տասականի</th>
                                <th>Տեսողական դասավորման հերդականությունը</th>
                                <th>Թարմացնել</th>
                            </tr>
                            </thead>
                            ...
                            <c:if test="${requestScope.cardsList != null}">
                                <c:forEach items="${requestScope.cardsList}" var="Cardmarkeing" varStatus="loop">
                                    <form action="UpdateCardApperanceInData" method="post">
                                        <tr>
                                            <td><c:out value="${Cardmarkeing.productCode}"/></td>
                                            <td><c:out value="${Cardmarkeing.cardName}"/></td>
                                            <td><c:out value="${Cardmarkeing.bankName}"/></td>
                                            <td><c:out value="${Cardmarkeing.cardType}"/></td>
                                            <td><c:out value="${Cardmarkeing.orderOfAppearance}"/></td>
                                            <input type="hidden" name="AppearanceNumber" class="form-control"
                                                   value="${Cardmarkeing.orderOfAppearance}"/>
                                            <input type="hidden" name="productCode" class="form-control"
                                                   value="${Cardmarkeing.productCode}"/>
                                            <input type="hidden" name="CardId" value="${Cardmarkeing.cardId}"/>
                                            <td>
                                                <button type="submit"
