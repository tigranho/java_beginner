        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="<%=request.getContextPath()%>/AddNewBankSmallLogo?bankId=<%=request.getAttribute("newBankId")%>" class="dropzone" method="post"
        ...
        <div class="demo-masked-input">
            <div class="row clearfix">
                <div class="col-md-3">
                    ...
                    <button type="submit" class="btn bg-orange btn-block btn-lg waves-effect">Վերջնական քայլ >
                    </button>
                        <input type="hidden" name="bankId" value="<%=request.getAttribute("newBankId")%>">
                    </form>
                </div>
