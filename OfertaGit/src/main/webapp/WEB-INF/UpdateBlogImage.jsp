    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form action="<%=request.getContextPath()%>/UpdateBlogImageInData?UAId=<%=request.getAttribute("UAId")%>"
                        ...
                        <div class="card profile-card">
                            ...
                            <div class="profile-body">
                                <div class="image-area">
                                    ...
                                    <c:forEach items="${requestScope.usefulArticlesList}" var="BlogInfo">
                                    <img src="${BlogInfo.UAImageLink}"
                                         alt="<c:out value="${BlogInfo.UAImageLink}"/>" height="250" width="250"/>
                                </div>
        ...
        <div class="body">
            <div class="demo-masked-input">
                <div class="row clearfix">
                    <div class="col-md-3">
                        <form action="BlogResultPage" method="post">
                            <button type="submit" class="btn btn-success m-t-15 waves-effect">Շարունակել
                            </button>
                            <input type="hidden" name="UAId" value="<%=request.getAttribute("UAId")%>">
                        </form>
                    </div>
                </div>
