    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                <form class="form-inline" action="SearchCl" method="get">
                                ...
                                <div class="card profile-card">
                                    ...
                                    <div class="profile-body">
                                        ...
                                        <div class="content-area">
                                            <h3>Վարկի անվանումը : <c:out value="${CLList.productName}"/></h3>

                                        </div>
                                        <div class="content-area">
                                            <h4>
                                                Վարկի կոդը : <c:out value="${CLList.productCode}"/></h4>
                                        </div>
                                    </div>
                                    <div class="profile-footer">
                                        <ul>
                                            <li>
                                                <span>Բանկ</span>
                                                <span><c:out
                                                        value="${CLList.bankName}"/></span>
                                            </li>

                                            <li>
                                                <span>Արժույթ</span>
                                                <span><c:out
                                                        value="${CLList.currancy}"/></span>
                                            </li>
                                            <li>
                                                <span>Նվազագույն գումար</span>
                                                <span><c:out
                                                        value="${CLList.CLMinAmount}"/></span>
                                            </li>

                                            <li>
                                                <span>Առավելագույն գումար</span>
                                                <span><c:out
                                                        value="${CLList.CLMaxAmount}"/></span>
                                            </li>

                                            <li>
                                                <span>Նվազագույն վարկ</span>
                                                <span><c:out
                                                        value="${CLList.CLMinLoan}"/></span>
                                            </li>

                                            <li>
                                                <span>Առավելագույն վարկ</span>
                                                <span><c:out
                                                        value="${CLList.CLMaxLoan}"/></span>
                                            </li>

                                            <li>
                                                <span>Փաստացի</span>
                                                <span><c:out
                                                        value="${CLList.CLFatual}"/> </span>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <span><c:out
                                                        value="${CLList.CLMinDownPayment}"/> </span>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <span><c:out
                                                        value="${CLList.CLMinServiceFee}"/> </span>
                                            </li>

                                            <li>
                                                <span>Առավելագույն ծառայության վճար</span>
                                                <span><c:out
                                                        value="${CLList.CLMaxServiceFee}"/> </span>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <span><c:out
                                                        value="${CLList.CLMinPeriodMonths}"/> Ամիս </span>
                                            </li>

                                            <li>
                                                <span>Առավելագույն ժամանակաշրջան</span>
                                                <span><c:out
                                                        value="${CLList.CLMaxPeriodMonths}"/> Ամիս</span>
                                            </li>

                                            <li>
                                                <span>Նվազագույն տարիքը</span>
                                                <span><c:out
                                                        value="${CLList.minAge}"/>  </span>
                                            </li>

                                            <li>
                                                <span>Առավելագույն տարիքը</span>
                                                <span><c:out
                                                        value="${CLList.maxAge}"/> </span>
                                            </li>



                                        </ul>
                                        <form action="UpdateCL" method="post">
                                            <button class="btn btn-primary btn-lg waves-effect btn-block">
                                                Թարմացնել Վարկի տվյալները
                                            </button>
                                            <input type="hidden" name="CLId" value="${CLList.CLId}">
                                        </form>
                                      <%--  <form action="UpdateProductName" method="post">
                                            <button class="btn btn-primary btn-lg waves-effect btn-block">
                                                Թարմացնել անվանումը
                                            </button>
                                            <input type="hidden" name="productCode" value="${CLList.productCode}">
                                        </form>--%>
                                        ...
                                        <form action="DeleteCL" method="post">
