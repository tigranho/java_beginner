        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <form action="UpdateTermsArmenianInData" method="post">
                        <div class="header">
                            <h2>
                                Մեր մասին Հայերեն
                        ...
                        <div class="body">
                            <c:if test="${requestScope.termsList != null}">
                                <c:forEach items="${requestScope.termsList}" var="TermsList">


                            <textarea id="ckeditor" name="termsText">
                                <c:out value="${TermsList.termsAm}"/>
                                 </textarea>
