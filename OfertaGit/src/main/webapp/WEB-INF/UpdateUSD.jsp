    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="UpdateUSDDetailsToData" method="post">
                        <div class="header">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="USD1Month" class="form-control"
                                                           value="${DepositFullList.usdMonth1}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="USD3Month" class="form-control"
                                                           value="${DepositFullList.usdMonth3}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="USD6Month" class="form-control"
                                                           value="${DepositFullList.usdMonth6}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="USD9Month" class="form-control"
                                                           value="${DepositFullList.usdMonth9}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="USD12Month" class="form-control"
                                                           value="${DepositFullList.usdMonth12}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="USD18Month" class="form-control"
                                                           value="${DepositFullList.usdMonth18}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="USD24Month" class="form-control"
                                                           value="${DepositFullList.usdMonth24}" step="0.01"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="USD36Month" class="form-control"
                                                           value="${DepositFullList.usdMonth36}" step="0.01"/>
