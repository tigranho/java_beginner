    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="AddNewMicroToData" method="post">
                        <div class="header">
                            ...
                            <h2 class="card-inside-title">Նոր  վարկեր տեղեկատվության ավելացում</h2>
                            <br>
                            <div class="row clearfix">
                               <%-- <div class="col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="ProductCode" class="form-control"/>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="ProductNameEng" class="form-control" required/>
                                            <label class="form-label" required>Վարկի անվանում Անգլերեն</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="ProductNameRus" class="form-control" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="MLMinAmount" class="form-control" required/>
                                            <label class="form-label" required>Վարկի նվազագույն գումարը</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="MLMinaxAmount" class="form-control" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="MLMinLoan" class="form-control" step="0.01" min="0" max="200" required/>
                                            <label class="form-label" required>Վարկի Նվազագույն %</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="MLMaxLoan" class="form-control" step="0.01" min="0" max="200" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="MLFatual" class="form-control" step="0.01" min="0" max="200" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="MMinPeriodDays" class="form-control" required/>
                                            <label class="form-label" required>Նվազագույն ժամկետը օր</label>
                                        </div>
                                    </div>

                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="MMaxPeriodDays" class="form-control" required/>
                                            <label class="form-label" required>Առավելագույն ժամկետը օր</label>
                                        </div>
                                    </div>
