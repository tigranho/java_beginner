    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                        <form class="form-inline" action="SearchAg" method="get">
...
<section class="content">
    <div class="container-fluid">
        <div class="row clearfix">
            <c:if test="${requestScope.AgricultureFullList != null}">
                <c:forEach items="${requestScope.AgricultureFullList}" var="AgList"
                           varStatus="loop">
                                ...
                                <div class="card profile-card">
                                    ...
                                    <div class="profile-body">
                                        ...
                                        <div class="content-area">
                                            <h3>Վարկի անվանումը : <c:out value="${AgList.productName}"/></h3>

                                        </div>
                                        <div class="content-area">
                                            <h4>
                                                Վարկի կոդը : <c:out value="${AgList.productCode}"/></h4>
                                        </div>
                                    </div>
                                    <div class="profile-footer">
                                        <ul>
                                            <li>
                                                <span>Բանկ</span>
                                                <span><c:out
                                                        value="${AgList.bankName}"/></span>
                                            </li>

                                            <li>
                                                <span>Արժույթ</span>
                                                <span><c:out
                                                        value="${AgList.currancy}"/></span>
                                            </li>
                                            <li>
                                                <span>Նվազագույն գումար</span>
                                                <span><c:out
                                                        value="${AgList.ACMinAmount}"/></span>
                                            </li>

                                            <li>
                                                <span>Առավելագույն գումար</span>
                                                <span><c:out
                                                        value="${AgList.ACMaxAmount}"/></span>
                                            </li>

                                            <li>
                                                <span>Նվազագույն վարկ</span>
                                                <span><c:out
                                                        value="${AgList.ACMinLoan}"/></span>
                                            </li>

                                            <li>
                                                <span>Առավելագույն վարկ</span>
                                                <span><c:out
                                                        value="${AgList.ACMaxLoan}"/></span>
                                            </li>

                                            <li>
                                                <span>Նվազագույն ժամանակաշրջան</span>
                                                <span><c:out
                                                        value="${AgList.ACMinPeriodMonth}"/> Ամիս</span>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <span><c:out
                                                        value="${AgList.ACMaxPeriodMonth}"/> Ամիս</span>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <span><c:out
                                                        value="${AgList.ACMinServiceFee}"/> </span>
                                            </li>

                                            <li>
                                                <span>Առավելագույն ծառայության վճար</span>
                                                <span><c:out
                                                        value="${AgList.ACMaxServiceFee}"/> </span>
                                            </li>

                                            <li>
                                                <span>Փաստացի</span>
                                                <span><c:out
                                                        value="${AgList.ACFactual}"/> </span>
                                            </li>
                                        </ul>
                                        <form action="UpdateAg" method="post">
                                            <button class="btn btn-primary btn-lg waves-effect btn-block">
                                                Թարմացնել Վարկի տվյալները
                                            </button>
                                            <input type="hidden" name="agId" value="${AgList.ACId}">
                                        </form>
                                     ...
                                     <%--   <form action="UpdateProductName" method="post">
                                            ...
                                            <input type="hidden" name="productCode" value="${AgList.productCode}">
                                        </form>--%>
                                        ...
                                        <form action="DeleteAg" method="post">
