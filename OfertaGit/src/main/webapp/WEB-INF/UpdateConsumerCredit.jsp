    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="UpdateConsumerCreditDetailsToData" method="post">
                        <div class="header">
                            ...
                            <c:if test="${requestScope.consumerCreditList != null}">
                                <c:forEach items="${requestScope.consumerCreditList}" var="ConsumerCreditList" varStatus="page">
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="content-area">
                                                <h4> Վարկի կոդը : <c:out value="${ConsumerCreditList.productCode}"/></h4>

                                            </div>
                                            <input type="hidden" name="ProductCode" value="${ConsumerCreditList.productCode}">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="ProductName" class="form-control"
                                                           value="${ConsumerCreditList.productName}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select class="form-control show-tick" id="BankName" name="BankName">
                                                        <option name="bankName" value="${ConsumerCreditList.bankName}" selected>${ConsumerCreditList.bankName}</option>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CoCMinAmount" class="form-control"
                                                           value="${ConsumerCreditList.CCMinAmount}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CoCMaxAmount" class="form-control"
                                                           value="${ConsumerCreditList.CCMaxAmount}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CoCMinCredit" class="form-control"
                                                           value="${ConsumerCreditList.CCMinAmount}" step="0.01" min="0" max="200"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CoCMaxCredit" class="form-control"
                                                           value="${ConsumerCreditList.CCMinAmount}" step="0.01" min="0" max="200"/>
                                                    <label class=" form-label">Վարկի նվազագույն %</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CoCPerFactual" class="form-control" value="${ConsumerCreditList.CCFactual}" step="0.01" min="0" max="200"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select class="form-control show-tick" id="cardType" name="currancy" >
                                                        <option name="currancy" value="${ConsumerCreditList.currancy}" selected>${ConsumerCreditList.currancy}</option>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CoCMinPeriodMonths" class="form-control" value="${ConsumerCreditList.CCMinPeriodMonth}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CoCMaxPeriodMonth" class="form-control" value="${ConsumerCreditList.CCMaxPeriodMonth}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CoCMinServiceFee" class="form-control" value="${ConsumerCreditList.CCMinServiceFee}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CoCMaxServiceFee" class="form-control" value="${ConsumerCreditList.CCMaxServiceFee}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CoCMinAge" class="form-control" value="${ConsumerCreditList.minAge}"/>
                                                    <label class="form-label">Վարկի նվազագույն թույլատրված տարիքը</label>
                                                </div>
                                            </div>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" name="CoCMaxAge" class="form-control" value="${ConsumerCreditList.maxAge}"/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="BankLink" class="form-control"
                                                           value="${ConsumerCreditList.bankLink}"/>
                                                    <label class="form-label">Բանկի հղում</label>
                                                </div>
                                            </div>

                                            <div class="col-xs-3">
                                                <input type="hidden" name="CLId" value="${ConsumerCreditList.CLId}"/>
