    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="AddAmdMonths" method="post">
                        <div class="header">
                            ...
                            <h2 class="card-inside-title">Ժամկետային ավանդների տարեկան տոկոսադրույքները AMD</h2>
                            <br>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <!-- /////////////////////////////////////////////////////////////////////////////////Comment Armenian -->
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="AMD1Month" class="form-control" value="0.0" step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="AMD3Month" class="form-control" value="0.0" step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="AMD6Month" class="form-control" value="0.0" step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="AMD9Month" class="form-control" value="0.0" step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="AMD12Month" class="form-control" value="0.0" step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="AMD18Month" class="form-control" value="0.0" step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="AMD24Month" class="form-control" value="0.0" step="0.01"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="AMD36Month" class="form-control" value="0.0" step="0.01"/>
