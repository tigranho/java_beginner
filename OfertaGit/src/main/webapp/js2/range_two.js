$(function() {
  ...
  var output_hyper = document.querySelectorAll('output')[0];
  ...
  $( "#value_amount_url_two" ).val(out_value);
  ...
  $("#amount_two").on("input", function() {
    ...
    output_hyper.textContent = max_num_hyper;
    $( "#value_amount_url_two" ).val(max_num_hyper);
    }
  });
  $("#amount_two").focusout(function(){
    ...
    if ( outputer_int < min_num ) {
      ...
      output_hyper.textContent = min_num;
        $( "#value_amount_url_two" ).val(min_num);
