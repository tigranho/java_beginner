...
@WebServlet("/DepositRangeController")
public class DepositRangeController extends HttpServlet {
    ...
    private String position ="ՀԻՓՈԹԵՔ";

    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            depositRangeController(request,response);
    ...
    private void depositRangeController(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, SQLException {
        request.setCharacterEncoding("UTF-8");
        sessionControlling(request, response);
        getAdminInfo(request, response);
        getMortgageRangebyPosition();
    ...
    private void getMortgageRangebyPosition() throws SQLException {
