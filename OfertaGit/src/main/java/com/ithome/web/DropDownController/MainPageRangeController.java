...
@WebServlet("/MainPageRangeController")
public class MainPageRangeController extends HttpServlet {
    ...
    private String position ="ԳԼԽԱՎՈՐ";

    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            mainPageRangeController(request,response);
    ...
    private void mainPageRangeController(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, SQLException {
