...
@WebServlet("/UpdateTermsArmenianInData")
public class UpdateTermsArmenianInData  extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            updateTermsArmenianInData(request,response);
    ...
    private void updateTermsArmenianInData(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, SQLException {
        request.setCharacterEncoding("UTF-8");
        sessionControlling(request, response);
        getAdminInfo(request, response);
        getParameters(request);
        UpdateTermsInDataArm(CreateNewTermsInData(1),request,response,1);
    }

    private void UpdateTermsInDataArm(int createNewTermsInData, HttpServletRequest request, HttpServletResponse response, int id) throws ServletException, IOException, SQLException {
    ...
    private void getArmenianTerms() throws SQLException {
