...
@WebServlet("/AgBanks")
public class AgBanks extends HttpServlet {
    ...
    private List<AgriculturalCredit> depositList = new ArrayList<>();
    ...
    private int bankID = 0;
    private List<AgriculturalCredit> deposiOposit = new ArrayList<>();
    ...
    AgriculturalCreditDao depositDaoController = new AgriculturalCreditDao();
    ...
    private void agBanks(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException, ServletException {
    ...
    private void gotoBanksPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/AGBankingBank.jsp").forward(request, response);
    }
    ...
    private void getOtherBanks() throws SQLException {
        List<AgriculturalCredit> depoposit = new ArrayList<>();
        deposiOposit = new ArrayList<>();
        depoposit =depositDaoController.getAllAgriculturalCreditList();
    ...
    private int getMinAmount() {
        for (int i = 0; i <depositList.size() ; i++) {
            MinAmount = depositList.get(i).getACMinAmount();
        }
        return MinAmount;
    }
