...
@WebServlet("/ConsumerBanks")
public class ConsumerBanks extends HttpServlet {
    ...
    private List<ConsumerCredit> depositList = new ArrayList<>();
    ...
    private int bankID = 0;
    private List<ConsumerCredit> deposiOposit = new ArrayList<>();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            consumerBanks(request,response);
    ...
    private void consumerBanks(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException, ServletException {
    ...
    private void gotoBanksPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/CBankingBank.jsp").forward(request, response);
    }
    ...
    private void getOtherBanks() throws SQLException {
        ...
        List<ConsumerCredit> depoposit = new ArrayList<>();
    ...
    private int getMinAmount() {
        for (int i = 0; i <depositList.size() ; i++) {
            MinAmount = depositList.get(i).getCCMinAmount();
        }
        return MinAmount;
    }
