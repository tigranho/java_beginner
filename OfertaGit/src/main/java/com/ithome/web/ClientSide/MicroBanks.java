...
@WebServlet("/MicroBanks")
public class MicroBanks extends HttpServlet {
    ...
    private List<MicroLoans> depositList = new ArrayList<>();
    ...
    private int bankID = 0;
    private List<MicroLoans> deposiOposit = new ArrayList<>();
    ...
    private void microBanks(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException, ServletException {
    ...
    private void getOtherBanks() throws SQLException {
        ...
        List<MicroLoans> depoposit= new ArrayList<>();
        depoposit = depositDaoController.getAllMicroLoans();
    ...
    class DepositComarator implements Comparator<MicroLoans> {
        ...
        public int compare(MicroLoans o1, MicroLoans o2) {
            return Double.compare(o2.getMLFatual(), o1.getMLFatual());
        }
    }
    ...
    class DepositComaratorAmount implements Comparator<MicroLoans> {
        ...
        @Override
        public int compare(MicroLoans o1, MicroLoans o2) {
            return Integer.compare(o2.getMLMinAmount(), o1.getMLMinAmount());
        }
    }
    ...
    private int getMinAmount() {
        for (int i = 0; i <depositList.size() ; i++) {
            MinAmount = depositList.get(i).getMLMinAmount();
        }
        return MinAmount;
    }
