...
public class Hashiv {
    ...
    public  List<FirstReplayment> displayMonthlyBalance(long loanAmount,
    ...
    public  double calculateMonthlyPayment(long loanAmount, int termInYears, double interestRate) {
        interestRate /= 100.0;
        double monthlyRate = interestRate / 12.0;
        int termInMonths = termInYears * 12;
    ...
    public  List<FirstReplayment> hashiv(long amount, float percentage, float months) {
        List<FirstReplayment> hashiv = new ArrayList<>();
