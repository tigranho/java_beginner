...
@WebServlet("/UpdateCardImageInData")
@MultipartConfig(fileSizeThreshold=1024*1024*2, // 2MB
        maxFileSize=1024*1024*10,      // 10MB
        maxRequestSize=1024*1024*50)   // 50MB
public class UpdateCardImageInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            updateCardImageInData(request,response);
    ...
    private void updateCardImageInData(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, SQLException {
    ...
    private void UploadImageToServer(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, SQLException {
        ...
        for (Part part : request.getParts()) {
            ...
            UpdateImageOfCard(request,response,filepat,cardId);
        }

    }

    private void UpdateImageOfCard(HttpServletRequest request, HttpServletResponse response, String filepat, int Pro) throws ServletException, IOException, SQLException {
        String linkToSave =  "http://www.oferta.am/" +filepat;
        Cards cards = new Cards(linkToSave);
        int UpdateImageInData = cardsDao.UpdateCardImageInDataById(cards,cardId);
    ...
    private void goBackToSamePage(HttpServletRequest request, HttpServletResponse response, String message) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/UpdateCardImage.jsp").forward(request, response);
    }
