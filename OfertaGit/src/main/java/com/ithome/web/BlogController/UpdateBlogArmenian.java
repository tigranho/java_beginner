...
@WebServlet("/UpdateBlogArmenian")
public class UpdateBlogArmenian extends HttpServlet {
    ...
    private void updateBlogArmenian(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, SQLException {
        ...
        getArmenianBlogById(UAId);
        setRequestToPage(request);
        gotoArmenianBlogUpdatePage(request,response);
    }
    private void gotoArmenianBlogUpdatePage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void getArmenianBlogById(int uaId) throws SQLException {
