...
@WebServlet("/UpdateBlogRussian")
public class UpdateBlogRussian extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            updateBlogRussian(request,response);
    ...
    private void updateBlogRussian(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, SQLException {
        request.setCharacterEncoding("UTF-8");
        sessionControlling(request,response);
        getAdminInfo(request,response);
        getParameters(request);
        getRussianBlogById(UAId);
        setRequestToPage(request);
        gotoRussianBlogUpdatePage(request,response);
    }
    private void gotoRussianBlogUpdatePage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void getRussianBlogById(int uaId) throws SQLException {
