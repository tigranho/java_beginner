...
public class ConsumerComparing extends PojoHelper {
    private int id;
    private int idCheck;
    private String SID;
    private int Amount;
    ...
    public ConsumerComparing() {
    }

    public ConsumerComparing(int idCheck, String SID, int amount, int months, int bankId, String productName, double percentage, int Service) {
    ...
    public String setBanksList(List<ConsumerComparing> depositList) throws SQLException {
