...
public class MicroComparing extends PojoHelper {
    private int id;
    private int idCheck;
    private String SID;
    private int Amount;
    ...
    public MicroComparing() {
    }

    public MicroComparing(int idCheck, String SID, int amount, int months, int bankId, String productName, double percentage, int Service) {
    ...
    public String setBanksList(List<MicroComparing> depositList) throws SQLException {
