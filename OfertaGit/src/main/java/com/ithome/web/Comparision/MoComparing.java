...
public class MoComparing extends PojoHelper {
    private int id;
    private int idCheck;
    private String SID;
    private int Amount;
    ...
    public MoComparing(int idCheck, String SID, int amount, int months, int bankId, String productName, double percentage, int Service, int prepaiment) {
    ...
    public String setBanksList(List<MoComparing> depositList) throws SQLException {
