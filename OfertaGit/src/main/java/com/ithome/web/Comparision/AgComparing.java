...
public class AgComparing extends PojoHelper {
    private int id;
    private int idCheck;
    private String SID;
    private int Amount;
    ...
    public AgComparing(int idCheck, String SID, int amount, int months, int bankId, String productName, double percentage, int Service) {
    ...
    public String setBanksList(List<AgComparing> depositList) throws SQLException {
