...
@WebServlet("/SendEmailForBank")
public class SendEmailFromBank extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        sendEmailFromBank(request, response);
    }
    ...
    private void sendEmailFromBank(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoToContactUsPageError(HttpServletRequest request, HttpServletResponse response,String message) throws ServletException, IOException {
        request.setAttribute("message",  message);
        System.out.println("message " + message);
        request.getRequestDispatcher("/CreditsSend").forward(request, response);
    }
